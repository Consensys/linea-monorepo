...
(defconstraint    create-instruction---one-step-reverting---undoing-creator-account-operations    (:guard    (create-instruction---one-step-reverting-precondition))
                  (begin
                    ...
                    (account-same-marked-for-deletion                CREATE_second_creator_account_row___row_offset)
                    ...
                    (vanishes!    (shift    account/RLPADDR_FLAG     CREATE_second_creator_account_row___row_offset))
...
(defconstraint    create-instruction---one-step-reverting---undoing-createe-account-operations    (:guard    (create-instruction---one-step-reverting-precondition))
                  (begin
                    ...
                    (account-same-marked-for-deletion                CREATE_second_createe_account_row___row_offset)
                    ...
                    (vanishes!    (shift    account/RLPADDR_FLAG     CREATE_second_createe_account_row___row_offset))
