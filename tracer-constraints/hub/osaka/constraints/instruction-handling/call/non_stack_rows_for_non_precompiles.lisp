...
(defconstraint    call-instruction---setting-NSR-for-non-precompiles    (:guard    (call-instruction---anything-but-precompile-entry))
                  (eq!    (shift    NON_STACK_ROWS    CALL_1st_stack_row___row_offset)
                          (+    (*    CALL_nsr___staticx                    (call-instruction---STACK-staticx))
                                (*    CALL_nsr___mxpx                       (call-instruction---STACK-mxpx))
                                (*    CALL_nsr___oogx                       (call-instruction---STACK-oogx))
                                (*    CALL_nsr___abort_will_revert          scenario/CALL_ABORT_WILL_REVERT)
                                (*    CALL_nsr___abort_wont_revert          scenario/CALL_ABORT_WONT_REVERT)
                                (*    CALL_nsr___eoa_success_will_revert    scenario/CALL_EOA_SUCCESS_CALLER_WILL_REVERT)
                                (*    CALL_nsr___eoa_success_wont_revert    scenario/CALL_EOA_SUCCESS_CALLER_WONT_REVERT)
                                (*    CALL_nsr___smc_failure_will_revert    scenario/CALL_SMC_FAILURE_CALLER_WILL_REVERT)
                                (*    CALL_nsr___smc_failure_wont_revert    scenario/CALL_SMC_FAILURE_CALLER_WONT_REVERT)
                                (*    CALL_nsr___smc_success_will_revert    scenario/CALL_SMC_SUCCESS_CALLER_WILL_REVERT)
                                (*    CALL_nsr___smc_success_wont_revert    scenario/CALL_SMC_SUCCESS_CALLER_WONT_REVERT)
                                )))
