...
(defun (USER-transaction---HUB---transaction-supports-eip-1559-gas-semantics ) (shift hub/TRANSACTION_TYPE_SUPPORTS_EIP_1559_GAS_SEMANTICS ROFF___USER___HUB_ROW))
(defun (USER-transaction---HUB---transaction-supports-delegation-lists       ) (shift hub/TRANSACTION_TYPE_SUPPORTS_DELEGATION_LISTS       ROFF___USER___HUB_ROW))
