...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;                                               ;;
;;   X Delegation related constraints            ;;
;;   X.Y Constraining COULD_BE_DELEGATION_CODE   ;;
;;                                               ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(defconstraint deployment-cant-delegate ()
               (if-not-zero   DEPLOYMENT_STATUS
                              (vanishes!   COULD_BE_DELEGATION_CODE)))

(defconstraint delegated-have-specific-size ()
               (if-zero  DEPLOYMENT_STATUS
                         (if-eq-else   CODE_SIZE   EIP_7702_DELEGATED_ACCOUNT_CODE_SIZE
                                       (eq! COULD_BE_DELEGATION_CODE 1)
...
(defproperty   code-that-COULD-not-be-delegated-cannot-ACTUALLY-be-delegated
               (if-zero   COULD_BE_DELEGATION_CODE
                          (vanishes!   ACTUALLY_DELEGATION_CODE)))


;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;                                               ;;
;;   X.Y Constraining ACTUALLY_DELEGATION_CODE   ;;
;;                                               ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;


(defconstraint delegate-code-leading-bytes-marker ()
    (if-eq-else   LEADING_THREE_BYTES   EIP_7702_DELEGATION_INDICATOR
                  (eq! ACTUALLY_DELEGATION_CODE 1)
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;                                         ;;
;;   X.Y Constraining DELEGATION_ADDRESS   ;;
;;                                         ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
