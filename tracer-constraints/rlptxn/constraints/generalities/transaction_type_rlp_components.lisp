...
(defun   (RLP-components-of-type-3-transactions)
  (+
    IS_RLP_PREFIX
    IS_CHAIN_ID
    IS_NONCE
...
(defproperty  admissible-RLP-components-for-type-3-transactions  (if  (==  TYPE_3  1)  (eq!  (RLP-components-of-type-3-transactions)  1)))
