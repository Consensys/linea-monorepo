...
class AsyncFriendlyTransactionManager : RawTransactionManager {
  ...
  ) : super(web3j, credentials, ChainId.NONE.toLong(), transactionReceiptProcessor) {
    this.web3j = web3j
    resetNonce().get()
  }
  ...
  fun resetNonce(): SafeFuture<Unit> {
    ...
    return SafeFuture.of(ethGetTransactionCount).thenApply {
