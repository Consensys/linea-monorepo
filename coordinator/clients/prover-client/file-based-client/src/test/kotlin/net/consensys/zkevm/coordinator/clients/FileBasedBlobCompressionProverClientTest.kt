...
class FileBasedBlobCompressionProverClientTest {
  private val blobCalculatorVersion = "0.1.0"
  private val conflationCalculatorVersion = "0.2.1"
  ...
  private val conflations = listOf(
    ConflationCalculationResult(
      ...
      tracesCounters = mapOf(), /* = Map<TracingModule, UInt> */
      dataL1Size = 1000U,
  ...
  private fun buildProverClient(
    ...
    return FileBasedBlobCompressionProverClient(
      FileBasedBlobCompressionProverClient.Config(
        ...
        blobCalculatorVersion = blobCalculatorVersion,
  ...
  fun fileBasedBlobCompressionProverClient_returnsProofs(
    ...
    whenever(
      mockFileMonitor.findFile(
        any(),
        any()
      )
    ).thenAnswer { SafeFuture.completedFuture(null) }
    ...
    whenever(
      ...
      Assertions.assertThat(it.getArgument<BlobCompressionProofJsonRequest>(0).eip4844Enabled).isFalse()
  ...
  fun fileBasedBlobCompressionProverClient_requestsWithEip4844(
    ...
    whenever(
      ...
      Assertions.assertThat(it.getArgument<BlobCompressionProofJsonRequest>(0).eip4844Enabled).isTrue()
      SafeFuture.completedFuture<Path>(
        it.getArgument(1)
      )
    }
