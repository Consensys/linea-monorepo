...
class ConflationCalculatorByTimeDeadlineTest {
  ...
  private lateinit var conflationCalculatorByTimeDeadline: ConflationTriggerCalculatorByTimeDeadline
  ...
  private fun checkDeadlineWasCalled(): Boolean {
    return Mockito.mockingDetails(conflationCalculatorByTimeDeadline).invocations
      .any { it.method.name == ConflationTriggerCalculatorByTimeDeadline::checkConflationDeadline.name }
  }
...
class ConflationCalculatorByTimeDeadlineRunnerTest {
  val mockCalculator: ConflationTriggerCalculatorByTimeDeadline = mock()
