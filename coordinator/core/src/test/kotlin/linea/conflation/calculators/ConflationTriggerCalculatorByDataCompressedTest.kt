...
class ConflationTriggerCalculatorByDataCompressedTest {
  private lateinit var calculator: ConflationTriggerCalculatorByDataCompressed
  ...
  private fun ConflationTriggerCalculatorByDataCompressed.checkAndAppendBlock(blockCounters: BlockCounters) {
