...
class GlobalBlockConflationCalculatorTest {
  private lateinit var calculatorByDealine: DeferredConflationTriggerCalculator
  private lateinit var calculatorByData: ConflationTriggerCalculator
