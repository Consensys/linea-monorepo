...
class GlobalBlockConflationCalculator(
  ...
  syncCalculators: List<ConflationTriggerCalculator>,
  deferredTriggerConflationCalculators: List<DeferredConflationTriggerCalculator>,
...
) : BlockConflationCalculator, ConflationTriggerConsumer {
  ...
  private var calculators: List<ConflationTriggerCalculator> = syncCalculators + deferredTriggerConflationCalculators
