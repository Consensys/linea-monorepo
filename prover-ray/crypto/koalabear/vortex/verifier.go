...
// multilinear variant: linear-combination consistency and multilinear statement
// check. No codeword check is needed — proof.LinearCombination holds T monomial
// coefficients, which implicitly describe a unique degree-<T polynomial.
