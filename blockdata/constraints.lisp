...
(defconstraint value-constraints (:guard (- REL_BLOCK (prev REL_BLOCK)))
  (begin  ; Coinbase
         ...
         (vanishes! (+ (* (^ 256 (- LLARGEMO 0))
                          (shift [BYTE_HI 0] ROW_SHIFT_COINBASE))
                       (* (^ 256 (- LLARGEMO 1))
                          (shift [BYTE_HI 1] ROW_SHIFT_COINBASE))
                       (* (^ 256 (- LLARGEMO 2))
                          (shift [BYTE_HI 2] ROW_SHIFT_COINBASE))
                       (* (^ 256 (- LLARGEMO 3))
                          (shift [BYTE_HI 3] ROW_SHIFT_COINBASE))
                       (* (^ 256 (- LLARGEMO 4))
                          (shift [BYTE_HI 4] ROW_SHIFT_COINBASE))
                       (* (^ 256 (- LLARGEMO 5))
                          (shift [BYTE_HI 5] ROW_SHIFT_COINBASE))
                       (* (^ 256 (- LLARGEMO 6))
                          (shift [BYTE_HI 6] ROW_SHIFT_COINBASE))
                       (* (^ 256 (- LLARGEMO 7))
                          (shift [BYTE_HI 7] ROW_SHIFT_COINBASE))
                       (* (^ 256 (- LLARGEMO 8))
                          (shift [BYTE_HI 8] ROW_SHIFT_COINBASE))
                       (* (^ 256 (- LLARGEMO 9))
                          (shift [BYTE_HI 9] ROW_SHIFT_COINBASE))
                       (* (^ 256 (- LLARGEMO 10))
                          (shift [BYTE_HI 10] ROW_SHIFT_COINBASE))
                       (* (^ 256 (- LLARGEMO 11))
                          (shift [BYTE_HI 11] ROW_SHIFT_COINBASE))))
         ...
         (vanishes! (+ (* (^ 256 (- LLARGEMO 0))
                          (shift [BYTE_LO 0] ROW_SHIFT_TIMESTAMP))
                       (* (^ 256 (- LLARGEMO 1))
                          (shift [BYTE_LO 1] ROW_SHIFT_TIMESTAMP))
                       (* (^ 256 (- LLARGEMO 2))
                          (shift [BYTE_LO 2] ROW_SHIFT_TIMESTAMP))
                       (* (^ 256 (- LLARGEMO 3))
                          (shift [BYTE_LO 3] ROW_SHIFT_TIMESTAMP))
                       (* (^ 256 (- LLARGEMO 4))
                          (shift [BYTE_LO 4] ROW_SHIFT_TIMESTAMP))
                       (* (^ 256 (- LLARGEMO 5))
                          (shift [BYTE_LO 5] ROW_SHIFT_TIMESTAMP))
                       (* (^ 256 (- LLARGEMO 6))
                          (shift [BYTE_LO 6] ROW_SHIFT_TIMESTAMP))
                       (* (^ 256 (- LLARGEMO 7))
                          (shift [BYTE_LO 7] ROW_SHIFT_TIMESTAMP))
                       (* (^ 256 (- LLARGEMO 8))
                          (shift [BYTE_LO 8] ROW_SHIFT_TIMESTAMP))
                       (* (^ 256 (- LLARGEMO 9))
                          (shift [BYTE_LO 9] ROW_SHIFT_TIMESTAMP))))
         ; NUMBER
         (eq! (shift INST ROW_SHIFT_NUMBER) EVM_INST_NUMBER)
         (vanishes! (shift DATA_HI ROW_SHIFT_NUMBER))
         (vanishes! (+ (* (^ 256 (- LLARGEMO 0))
                          (shift [BYTE_LO 0] ROW_SHIFT_NUMBER))
                       (* (^ 256 (- LLARGEMO 1))
                          (shift [BYTE_LO 1] ROW_SHIFT_NUMBER))
                       (* (^ 256 (- LLARGEMO 2))
                          (shift [BYTE_LO 2] ROW_SHIFT_NUMBER))
                       (* (^ 256 (- LLARGEMO 3))
                          (shift [BYTE_LO 3] ROW_SHIFT_NUMBER))
                       (* (^ 256 (- LLARGEMO 4))
                          (shift [BYTE_LO 4] ROW_SHIFT_NUMBER))
                       (* (^ 256 (- LLARGEMO 5))
                          (shift [BYTE_LO 5] ROW_SHIFT_NUMBER))
                       (* (^ 256 (- LLARGEMO 6))
                          (shift [BYTE_LO 6] ROW_SHIFT_NUMBER))
                       (* (^ 256 (- LLARGEMO 7))
                          (shift [BYTE_LO 7] ROW_SHIFT_NUMBER))
                       (* (^ 256 (- LLARGEMO 8))
                          (shift [BYTE_LO 8] ROW_SHIFT_NUMBER))
                       (* (^ 256 (- LLARGEMO 9))
                          (shift [BYTE_LO 9] ROW_SHIFT_NUMBER))))
