...
// Forked from OpenZeppelin Contracts (last updated v4.8.1) (token/ERC20/extensions/ERC20Votes.sol)
// Changes:
// It uses super.balanceOf instead of balanceOf to be sure it counts
// only actual token balances and not the virtual Karma generated by Karma distributors.
...
/**
 * @dev Extension of ERC20 to support Compound-like voting and delegation. This version is more generic than
 * Compound's,
...
abstract contract ERC20VotesUpgradeable is Initializable, IVotesUpgradeable, ERC20PermitUpgradeable {
    ...
    function _checkpointsLookup(Checkpoint[] storage ckpts, uint256 blockNumber) private view returns (uint256) {
        ...
        // Once we reach a single value (when low == high), we've found the right checkpoint at the index high-1, if
        // not
    ...
    function _delegate(address delegator, address delegatee) internal virtual {
        ...
        uint256 delegatorBalance = super.balanceOf(delegator);
