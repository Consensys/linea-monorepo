module github.com/consensys/linea-monorepo/verifier-ray/testdata/generate

go 1.25.7

require (
	github.com/consensys/linea-monorepo/prover-ray v0.0.0-20260610132712-f735159cffa9
