...
clean-smc-folders:
		@echo "No OZ upgrade artifacts to clean (migrated to vanilla proxies)"
...
deploy-eip-system-contracts:
		...
		npx tsx local-deployments-artifacts/deployEIPSystemContracts.ts
...
deploy-upgradeable-predeploys:
		...
		DEPLOYER_PRIVATE_KEY=$${DEPLOYMENT_PRIVATE_KEY:-0x1dd171cec7e2995408b5513004e8207fe88d6820aeff0d82463b3e41df251aae} \
		RPC_URL=http:\\localhost:8545/ \
		npx tsx local-deployments-artifacts/deployPredeployContractsV1.ts
...
deploy-linea-rollup:
		...
		npx tsx local-deployments-artifacts/deployPlonkVerifierAndLineaRollupV$(L1_CONTRACT_VERSION).ts
...
deploy-validium:
		...
		npx tsx local-deployments-artifacts/deployPlonkVerifierAndValidiumV$(L1_CONTRACT_VERSION).ts
...
deploy-l2messageservice:
		...
		npx tsx local-deployments-artifacts/deployL2MessageServiceV1.ts
...
deploy-token-bridge-l1:
		...
		npx tsx local-deployments-artifacts/deployBridgedTokenAndTokenBridgeV1_1.ts
...
deploy-l1-test-erc20:
		...
		npx tsx local-deployments-artifacts/deployTestERC20.ts
...
deploy-contracts:
	cd contracts/; \
	export L1_NONCE=$$(npx tsx local-deployments-artifacts/get-wallet-nonce.ts --wallet-priv-key 0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80 --rpc-url http://localhost:8445) && \
	export L2_NONCE=$$(npx tsx local-deployments-artifacts/get-wallet-nonce.ts --wallet-priv-key 0x1dd171cec7e2995408b5513004e8207fe88d6820aeff0d82463b3e41df251aae --rpc-url http://localhost:8545) && \
	cd .. && \
...
deploy-l2-evm-opcode-tester:
		...
		RPC_URL=http:\\localhost:8545/ \
		npx tsx local-deployments-artifacts/deployCancunEvmTestingFramework.ts
...
evm-opcode-tester-execute-all-opcodes:
		...
		DEPLOYER_PRIVATE_KEY=0x8f2a55949038a9610f50fb23b5883af3b4ecb3c3bb792cbcefbd1542c692be63 \
		RPC_URL=http:\\localhost:8545/ \
		npx tsx local-deployments-artifacts/executeAllOpcodes.ts
...
deploy-l2-scenario-testing-proxy:
		...
		DEPLOYER_PRIVATE_KEY=0x1dd171cec7e2995408b5513004e8207fe88d6820aeff0d82463b3e41df251aae \
		RPC_URL=http:\\localhost:8545/ \
		npx tsx local-deployments-artifacts/deployLineaScenarioDelegatingProxy.ts
...
execute-scenario-testing-proxy-scenario:
		...
		DEPLOYER_PRIVATE_KEY=0x1dd171cec7e2995408b5513004e8207fe88d6820aeff0d82463b3e41df251aae \
		RPC_URL=http:\\localhost:8545/ \
		npx tsx local-deployments-artifacts/executeLineaScenarioDelegatingProxyScenario.ts
