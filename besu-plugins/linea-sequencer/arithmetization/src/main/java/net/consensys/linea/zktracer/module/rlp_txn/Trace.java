...
public record Trace(
  ...
  static class TraceBuilder {
    ...
    private final List<UnsignedByte> counter;
    ...
    @JsonProperty("nSTEP")
    private final List<UnsignedByte> nStep;
    ...
    @JsonProperty("TYPE")
    private final List<UnsignedByte> type;
