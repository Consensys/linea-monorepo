...
public class LineaTransactionSelectionResult extends TransactionSelectionResult {
  private enum LineaStatus implements TransactionSelectionResult.Status {
    ...
    EXECUTION_INTERRUPTED(true, false, false);
  ...
  public static final TransactionSelectionResult EXECUTION_INTERRUPTED =
      new LineaTransactionSelectionResult(LineaStatus.EXECUTION_INTERRUPTED);
}
