  ...
  public Object trace(final MessageFrame frame) {
    ...
    for (int ct = 0; ct < maxCounter(data); ct++) {
      ...
      builder
          ...
          .appendAcc_B_0(data.getBBytes().get(0).slice(0, accLength).toUnsignedBigInteger())
          .appendAcc_B_1(data.getBBytes().get(1).slice(0, accLength).toUnsignedBigInteger())
          .appendAcc_B_2(data.getBBytes().get(2).slice(0, accLength).toUnsignedBigInteger())
          .appendAcc_B_3(data.getBBytes().get(3).slice(0, accLength).toUnsignedBigInteger())
          .appendAcc_R_0(data.getRBytes().get(0).slice(0, accLength).toUnsignedBigInteger())
          .appendAcc_R_1(data.getRBytes().get(1).slice(0, accLength).toUnsignedBigInteger())
          .appendAcc_R_2(data.getRBytes().get(2).slice(0, accLength).toUnsignedBigInteger())
          .appendAcc_R_3(data.getRBytes().get(3).slice(0, accLength).toUnsignedBigInteger())
          .appendAcc_Q_0(data.getQBytes().get(0).slice(0, accLength).toUnsignedBigInteger())
          .appendAcc_Q_1(data.getQBytes().get(1).slice(0, accLength).toUnsignedBigInteger())
          .appendAcc_Q_2(data.getQBytes().get(2).slice(0, accLength).toUnsignedBigInteger())
          .appendAcc_Q_3(data.getQBytes().get(3).slice(0, accLength).toUnsignedBigInteger())
          ...
          .appendByte_B_0(UnsignedByte.of(data.getBBytes().get(0).get(ct)))
          .appendByte_B_1(UnsignedByte.of(data.getBBytes().get(1).get(ct)))
          .appendByte_B_2(UnsignedByte.of(data.getBBytes().get(2).get(ct)))
          .appendByte_B_3(UnsignedByte.of(data.getBBytes().get(3).get(ct)))
          .appendByte_R_0(UnsignedByte.of(data.getRBytes().get(0).get(ct)))
          .appendByte_R_1(UnsignedByte.of(data.getRBytes().get(1).get(ct)))
          .appendByte_R_2(UnsignedByte.of(data.getRBytes().get(2).get(ct)))
          .appendByte_R_3(UnsignedByte.of(data.getRBytes().get(3).get(ct)))
          .appendByte_Q_0(UnsignedByte.of(data.getQBytes().get(0).get(ct)))
          .appendByte_Q_1(UnsignedByte.of(data.getQBytes().get(1).get(ct)))
          .appendByte_Q_2(UnsignedByte.of(data.getQBytes().get(2).get(ct)))
          .appendByte_Q_3(UnsignedByte.of(data.getQBytes().get(3).get(ct)))
          ...
          .appendByte_H_0(UnsignedByte.of(data.getHBytes().get(0).get(ct)))
          .appendByte_H_1(UnsignedByte.of(data.getHBytes().get(1).get(ct)))
          .appendByte_H_2(UnsignedByte.of(data.getHBytes().get(2).get(ct)))
          .appendAcc_H_0(
              Bytes.wrap(data.getHBytes().get(0)).slice(0, ct + 1).toUnsignedBigInteger())
          .appendAcc_H_1(
              Bytes.wrap(data.getHBytes().get(1)).slice(0, ct + 1).toUnsignedBigInteger())
          .appendAcc_H_2(
              Bytes.wrap(data.getHBytes().get(2)).slice(0, ct + 1).toUnsignedBigInteger())
