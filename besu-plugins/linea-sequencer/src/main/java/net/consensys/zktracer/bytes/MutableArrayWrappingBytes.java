...
import static net.consensys.zktracer.bytes.Checks.checkElementIndex;

import java.util.Arrays;
import org.apache.tuweni.bytes.Bytes;
import org.apache.tuweni.bytes.MutableBytes;

class MutableArrayWrappingBytes extends net.consensys.zktracer.bytes.ArrayWrappingBytes implements MutableBytes {
  ...
  public MutableBytes mutableSlice(int i, int length) {
    ...
    return length == Bytes16.SIZE
        ? new net.consensys.zktracer.bytes.MutableArrayWrappingBytes16(bytes, offset + i)
  ...
  @Override
  public Bytes copy() {
    return new net.consensys.zktracer.bytes.ArrayWrappingBytes(toArray());
  }
