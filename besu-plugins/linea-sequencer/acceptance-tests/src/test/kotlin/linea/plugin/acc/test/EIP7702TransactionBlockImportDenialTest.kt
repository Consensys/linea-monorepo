...
/**
 * Tests that verify EIP-7702 DELEGATE_CODE transactions are correctly rejected during block import
...
class EIP7702TransactionBlockImportDenialTest : LineaPluginPoSTestBase() {
  ...
  fun EIP7702TransactionIsRejectedFromNodeImport() {
    ...
    assertBlockImportRejected(
      response,
      TransactionTypeValidationErrors.DELEGATE_CODE_TX_NOT_ALLOWED,
    )
  }
