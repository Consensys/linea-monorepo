...
(defun (ct_max_second_input)
    (+ (* CT_MAX_SMALL_POINT RSLT_BLS_G1_ADD_FLAG)
       (* CT_MAX_SCALAR RSLT_BLS_G1_MSM_FLAG)
       (* CT_MAX_LARGE_POINT RSLT_BLS_G2_ADD_FLAG)
       (* CT_MAX_SCALAR RSLT_BLS_G2_MSM_FLAG)
       (* CT_MAX_LARGE_POINT RSLT_BLS_PAIRING_CHECK_FLAG)))
