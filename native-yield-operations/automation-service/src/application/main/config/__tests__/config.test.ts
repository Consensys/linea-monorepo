...
const createValidEnv = () => ({
  ...
  LIDO_STAKING_VAULT_ADDRESS: "0x6666666666666666666666666666666666666666",
  ...
  WEB3SIGNER_PUBLIC_KEY: `0x02${"b".repeat(64)}`,
  ...
  it("maps a validated environment into bootstrap config", () => {
    ...
    expect(config).toMatchObject({
      ...
      contractAddresses: {
        ...
        lidoStakingVaultAddress: env.LIDO_STAKING_VAULT_ADDRESS,
