...
class EthConnectionImpl(url: String?) : EthConnection {
  ...
  /**
   * //To use "http://localhost:443", first do
   * // kubectl port-forward service/geth-archives-lb 443:8545 -n zk
   * // To make calls via public endpoint but with rate limiter:
   * // use "https://rpc.goerli.linea.build"
   */
  init {
