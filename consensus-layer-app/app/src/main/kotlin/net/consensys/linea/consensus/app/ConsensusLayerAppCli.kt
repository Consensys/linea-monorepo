...
internal constructor(private val errorWriter: PrintWriter, private val startAction: StartAction) :
  ...
  override fun call(): Int {
    return try {
      ...
      val configs: Validated<ConfigFailure, ConsensusLayerAppConfig> = configs(configFiles)
  ...
  fun configs(configFiles: List<File>): Validated<ConfigFailure, ConsensusLayerAppConfig> {
    ...
    val config: Validated<ConfigFailure, ConsensusLayerAppConfig> =
      confBuilder.build().loadConfig<ConsensusLayerAppConfig>(emptyList())
