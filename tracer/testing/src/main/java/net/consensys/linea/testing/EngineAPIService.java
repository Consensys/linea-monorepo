...
public class EngineAPIService {
   ...
   */
  public void buildNewBlock(Fork fork, long blockTimestampSeconds, long blockBuildingTimeMs)
      throws IOException, InterruptedException {
    final EthBlock.Block latestBlock = node.execute(ethTransactions.block());

    final Call buildBlockRequest =
        createForkChoiceRequest(fork, latestBlock.getHash(), blockTimestampSeconds);
