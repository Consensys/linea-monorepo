...
public record AddTrace(
    @JsonProperty("Trace") AddTrace.Trace trace, @JsonProperty("Stamp") int stamp) {
  @JsonPropertyOrder({
    "ACC_1",
    "ACC_2",
    "ARG_1_HI",
  ...
  public record Trace(
    ...
    public static class Builder {
      ...
      public AddTrace build() {
        return new AddTrace(
            new AddTrace.Trace(
                acc1, acc2, arg1Hi, arg1Lo, arg2Hi, arg2Lo, byte1, byte2, counter, inst, overflow,
                resHi, resLo, addStamp),
            stamp);
      }
    }
  }
