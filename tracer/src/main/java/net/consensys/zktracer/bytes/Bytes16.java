...
import static net.consensys.zktracer.bytes.Checks.checkArgument;
import static net.consensys.zktracer.bytes.Checks.checkNotNull;
...
public interface Bytes16 extends Bytes {
  ...
  static Bytes16 wrap(byte[] bytes, int offset) {
    checkNotNull(bytes);
    return new net.consensys.zktracer.bytes.ArrayWrappingBytes16(bytes, offset);
  }
  ...
  static Bytes16 leftPad(Bytes value) {
    ...
    net.consensys.zktracer.bytes.MutableBytes16 result = net.consensys.zktracer.bytes.MutableBytes16.create();
  ...
  default Bytes16 and(Bytes16 other) {
    return and(other, net.consensys.zktracer.bytes.MutableBytes16.create());
  }
  ...
  default Bytes16 or(Bytes16 other) {
    return or(other, net.consensys.zktracer.bytes.MutableBytes16.create());
  }
  ...
  default Bytes16 xor(Bytes16 other) {
    return xor(other, net.consensys.zktracer.bytes.MutableBytes16.create());
  }

  @Override
  default Bytes16 not() {
    return not(net.consensys.zktracer.bytes.MutableBytes16.create());
  }

  @Override
  default Bytes16 shiftRight(int distance) {
    return shiftRight(distance, net.consensys.zktracer.bytes.MutableBytes16.create());
  }

  @Override
  default Bytes16 shiftLeft(int distance) {
    return shiftLeft(distance, net.consensys.zktracer.bytes.MutableBytes16.create());
  }
