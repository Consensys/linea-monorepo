...
import net.consensys.zktracer.bytes.MutableBytes16;
import org.apache.tuweni.bytes.Bytes;
import org.apache.tuweni.bytes.DelegatingBytes;

public class DelegatingBytes16 extends DelegatingBytes implements
    net.consensys.zktracer.bytes.Bytes16 {
  ...
  @Override
  public int size() {
    return net.consensys.zktracer.bytes.Bytes16.SIZE;
  }

  @Override
  public net.consensys.zktracer.bytes.Bytes16 copy() {
    return Bytes16.wrap(toArray());
  }

  @Override
  public net.consensys.zktracer.bytes.MutableBytes16 mutableCopy() {
