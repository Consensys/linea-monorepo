...
public class LeosNewRanges {
  ...
  void leos_new_ranges_2258472_2258607() {
    replay(LINEA_MAINNET, "2258472-2258607.json.gz");
  }

  @Test
  void leos_new_ranges_2291967_2292180() {
    replay(LINEA_MAINNET, "2291967-2292180.json.gz");
  }
  ...
  void leos_new_ranges_2359782_2359913() {
    replay(LINEA_MAINNET, "2359782-2359913.json.gz");
  }
  ...
  void leos_new_ranges_5004016_5004055() {
    replay(LINEA_MAINNET, "5004016-5004055.json.gz");
  }

  @Test
  void leos_new_ranges_5004767_5004806() {
    replay(LINEA_MAINNET, "5004767-5004806.json.gz");
  }

  @Test
  void leos_new_ranges_5006057_5006092() {
    replay(LINEA_MAINNET, "5006057-5006092.json.gz");
  }
  ...
  void leos_new_ranges_5042942_5042990() {
    replay(LINEA_MAINNET, "5042942-5042990.json.gz");
  }

  @Test
  void leos_new_ranges_5043442_5043497() {
    replay(LINEA_MAINNET, "5043442-5043497.json.gz");
  }

  @Test
  void leos_new_ranges_5043997_5044049() {
    replay(LINEA_MAINNET, "5043997-5044049.json.gz");
  }

  @Test
  void leos_new_ranges_5044557_5044619() {
    replay(LINEA_MAINNET, "5044557-5044619.json.gz");
  }

  @Test
  void leos_new_ranges_5045161_5045232() {
    replay(LINEA_MAINNET, "5045161-5045232.json.gz");
  }

  @Test
  void leos_new_ranges_5046373_5046435() {
    replay(LINEA_MAINNET, "5046373-5046435.json.gz");
  }

  @Test
  void leos_new_ranges_5046997_5047058() {
    replay(LINEA_MAINNET, "5046997-5047058.json.gz");
  }

  @Test
  void leos_new_ranges_5050036_5050130() {
    replay(LINEA_MAINNET, "5050036-5050130.json.gz");
  }

  @Test
  void leos_new_ranges_5057558_5057616() {
    replay(LINEA_MAINNET, "5057558-5057616.json.gz");
  }
}
