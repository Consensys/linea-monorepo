...
package net.consensys.linea.zktracer.forkSpecific.prague;
...
public class SystemTransaction2935Tests extends TracerTestBase {
  ...
  void systemTransactionConsistencyTest() {
    BytecodeRunner.of(
            BytecodeCompiler.newProgram(testInfo)
                ...
                .push(0) // argOffset
                .push(0) // value
                .push(HISTORY_STORAGE_ADDRESS) // address
                .push(757575) // gas
                .op(OpCode.CALL)
