...
public class LondonAdd extends Add {
  ...
  public static final class Operation extends AddOperation {
    private static final UInt256 TWO_TO_THE_128 = UInt256.ONE.shiftLeft(128);

    private BaseBytes res;
    private int ctMax;

    public Operation(OpCode opCode, Bytes32 arg1, Bytes32 arg2) {
