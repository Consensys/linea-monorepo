...
## [1.1.0-rc2] - 2026-05-28

### [coordinator] - [v0.1.1-rc2](https://github.com/Consensys/linea-monorepo/releases/tag/releases%2Fcoordinator%2Fv0.1.1-rc2)
...
- *(coordinator)* Rename packages net.consensys.zkevm.* -> linea.* (#3105)
- *(coordinator)* Log and message error improvements (#3193)
### [maru] - [v1.0.1-rc2](https://github.com/Consensys/linea-monorepo/releases/tag/releases%2Fmaru%2Fv1.0.1-rc2)
...
- *(misc)* Align spotless with linea-monorepo (#516)
- *(ci)* Fix merge conflict
### [postman] - [v1.0.1-rc2](https://github.com/Consensys/linea-monorepo/releases/tag/releases%2Fpostman%2Fv1.0.1-rc2)

#### ⚙️ Miscellaneous Tasks

- *(deps)* Refresh monorepo dependencies (#3061)
- *(deps)* Update Jest to 30.4 (#3077)
### [prover] - [v1.0.1-rc2](https://github.com/Consensys/linea-monorepo/releases/tag/releases%2Fprover%2Fv1.0.1-rc2)
...
- Update to latest gnark and gnark-crypto (#3142)
- Update gnark dependency (#3215)
### [tx-exclusion-api] - [v1.0.1-rc2](https://github.com/Consensys/linea-monorepo/releases/tag/releases%2Ftx-exclusion-api%2Fv1.0.1-rc2)

#### ⚙️ Miscellaneous Tasks

- *(coordinator)* Rename package net.consensys.zkevm.persistence to linea.persistence #3073
### [linea-besu-package] - [v1.0.1-rc2](https://github.com/Consensys/linea-monorepo/releases/tag/releases%2Flinea-besu-package%2Fv1.0.1-rc2)
