...
BRIDGE_TX_HASH="$(printf '%s\n' "$BRIDGE_RECEIPT" | json_string_field transactionHash)"
require_hash "bridge tx hash" "$BRIDGE_TX_HASH"
log "bridgeTx: https://sepolia.etherscan.io/tx/$BRIDGE_TX_HASH"
