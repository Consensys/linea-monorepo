...
(defun (phase-sum)
  (+ (* MODEXP_PHASE_BASE IS_MODEXP_BASE)
     (* MODEXP_PHASE_EXPONENT IS_MODEXP_EXPONENT)
     (* MODEXP_PHASE_MODULUS IS_MODEXP_MODULUS)
     (* MODEXP_PHASE_RESULT IS_MODEXP_RESULT)
     (* BLAKE_PHASE_DATA IS_BLAKE_DATA)
     (* BLAKE_PHASE_PARAMS IS_BLAKE_PARAMS)
     (* BLAKE_PHASE_RESULT IS_BLAKE_RESULT)))
