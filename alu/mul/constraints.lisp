...
(defconstraint stamp-update () (vanishes (* (will-inc STAMP 1) (remains-constant STAMP))))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;                                           ;;
;;    1.4 binary and bytehood constraints    ;;
;;                                           ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;; TODO: bytehood constraints for the following
;; BYTE_A_3
;; BYTE_A_2
;; BYTE_A_1
;; BYTE_A_0
...
(defconstraint nontrivial-mul-regime ()
  (if-eq CT MMEDIUMMO
         ...
         (if-not-zero (- INST EXP)
                      ...
                      (begin (= ARG_1_HI     (+ (* THETA (A_3)) (A_2)))
                             (= ARG_1_LO     (+ (* THETA (A_1)) (A_0)))
                             (= ARG_2_HI     (+ (* THETA (B_3)) (B_2)))
                             (= ARG_2_LO     (+ (* THETA (B_1)) (B_0)))
                             (= RES_HI       (+ (* THETA (C_3)) (C_2)))
                             (= RES_LO       (+ (* THETA (C_1)) (C_0)))
                             ;; multiplication per se
                             (set-multiplication (A_3) (A_2) (A_1) (A_0)
                                                 (B_3) (B_2) (B_1) (B_0)
                                                 (C_3) (C_2) (C_1) (C_0)
                                                 (H_3) (H_2) (H_1) (H_0)
                                                 (alpha) (beta) (eta) (mu))))))
...
(defun (preparations-for-a-lower-bound-on-the-2-adicity-of-the-base)
    (begin
     ;; recall that BYTE_C_0 will be either 0 or 1 !
     ;; cf. (special-constraints-for-byte-c-0)
     (if-not-zero BYTE_C_0
                  (prepare-lower-bound-on-two-adicity
                   BYTE_A_0 BYTE_C_1 BITS
                   BYTE_C_3 BYTE_H_3
                   BYTE_C_2 BYTE_H_2
                   CT))
     (if-not-zero (- 1 BYTE_C_0)
                  (prepare-lower-bound-on-two-adicity
                   BYTE_A_1 BYTE_C_1 BITS
                   BYTE_C_3 BYTE_H_3
                   BYTE_C_2 BYTE_H_2
                   CT))))
    ...
    (if-eq CT MMEDIUMMO
           (if-eq-else (test-for-bytehood-of-arg-2) BYTE_B_0
                       ...
                       (begin (if-not-zero BYTE_C_0
                                           (=  (* (B_0) (nu2-byte-c-0-equals-1))
                                               (+ 256 (H_1))))
                              (if-not-zero (- 1 BYTE_C_0)
                                           (=  (* (B_0) (nu2-byte-c-0-equals-0))
                                               (+ 256 (H_1)))))
                       ;; ARG_2 isn't a byte
                       (begin (if-not-zero BYTE_C_0
                                           (=  (nu2-byte-c-0-equals-1)
                                               (+ 1 (H_1))))
                              (debug (if-not-zero (- 1 BYTE_C_0)
                                                  (=  (nu2-byte-c-0-equals-0)
                                                      (+ 1 (H_1)))))))))
...
(defun (target-arg1)
    (begin
     (= ARG_1_HI (+ (* THETA (A_3)) (A_2)))
     (= ARG_1_LO (+ (* THETA (A_1)) (A_0)))))

(defun (first-square-and-multiply)
    (if-not-zero (- (shift STAMP -8) STAMP)
                 (begin (= ARG_1_HI (+ (* THETA (C_3)) (C_2)))
                        (= ARG_1_LO (+ (* THETA (C_1)) (C_0))))))
