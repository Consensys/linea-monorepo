...
(defconst
  ...
  MOD                    6
  SMOD                   7
  MMEDIUM                8 ;counter cycles last 8 rows
  MMEDIUMMO              7
...
(defun (lt_0)   (shift CMP_1 -7))       (defun (eq_0)     (shift CMP_2 -7))
(defun (lt_1)   (shift CMP_1 -6))       (defun (eq_1)     (shift CMP_2 -6))
(defun (lt_2)   (shift CMP_1 -5))       (defun (eq_2)     (shift CMP_2 -5))
(defun (lt_3)   (shift CMP_1 -4))       (defun (eq_3)     (shift CMP_2 -4))
...
(defconstraint byte-decompositions ()
  (begin
   (byte-decomposition  CT  ACC_1_3      BYTE_1_3)
...
(defconstraint target-constraints (:guard STAMP)
               (if-zero OLI
                        (if-eq CT MMEDIUMMO
                               (begin
                                (=  ARG_1_HI (+ (* THETA (ARG1_3)) (ARG1_2)))
                                (=  ARG_2_HI (+ (* THETA (ARG2_3)) (ARG2_2)))
                                        ;
                                (=  (shift BYTE_1_3 -7) (bit-dec-msb1))
                                (=  (shift BYTE_2_3 -7) (bit-dec-msb2))
                                        ;
                                (=  (+ (Delta_3) (lt_3)) (* (- (* 2 (lt_3)) 1) (- (B_3) (R_3))))
                                (=  (+ (Delta_2) (lt_2)) (* (- (* 2 (lt_2)) 1) (- (B_2) (R_2))))
                                (=  (+ (Delta_1) (lt_1)) (* (- (* 2 (lt_1)) 1) (- (B_1) (R_1))))
                                (=  (+ (Delta_0) (lt_0)) (* (- (* 2 (lt_0)) 1) (- (B_0) (R_0))))
                                        ;
                                (=  (+ (* (B_0) (Q_1)) (* (B_1) (Q_0)))
