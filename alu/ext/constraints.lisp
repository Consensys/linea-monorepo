...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;                                           ;;
;;    6.5 Binary and bytehood constraints    ;;
;;                                           ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defun (J_0)        ACC_J_0)
;;
(defun (lt_0)       (shift CMP -7))
(defun (lt_1)       (shift CMP -6))
(defun (lt_2)       (shift CMP -5))
(defun (lt_3)       (shift CMP -4))
(defun (eq_0)       (shift CMP -3))
(defun (eq_1)       (shift CMP -2))
(defun (eq_2)       (shift CMP -1))
(defun (eq_3)       CMP)
;;
(defun (alpha)      (shift OF_H -7))
(defun (beta_0)     (shift OF_H -6))
(defun (beta_1)     (shift OF_H -5))
(defun (gamma)      (shift OF_H -4))
(defun (beta)       (+  (* 2 (beta_1))  (beta_0)))
;;
(defun (sigma)      (shift OF_I -7))
(defun (tau_0)      (shift OF_I -6))
(defun (tau_1)      (shift OF_I -5))
(defun (rho_0)      (shift OF_I -4))
(defun (rho_1)      (shift OF_I -3))
(defun (tau)        (+  (* 2 (tau_1))   (tau_0)))
(defun (rho)        (+  (* 2 (rho_1))   (rho_0)))
;;
(defun (phi_0)      (shift OF_J -7))
(defun (phi_1)      (shift OF_J -6))
(defun (psi_0)      (shift OF_J -5))
(defun (psi_1)      (shift OF_J -4))
(defun (psi_2)      (shift OF_J -3))
(defun (chi_0)      (shift OF_J -2))
(defun (chi_1)      (shift OF_J -1))
(defun (chi_2)             OF_J)
(defun (phi)        (+                  (* 2 (phi_1))   (phi_0)))
(defun (psi)        (+  (* 4 (psi_2))   (* 2 (psi_1))   (psi_0)))
(defun (chi)        (+  (* 4 (chi_2))   (* 2 (chi_1))   (chi_0)))
;;
(defun (lambda)     (shift OF_RES -7))
(defun (mu_0)       (shift OF_RES -6))
(defun (mu_1)       (shift OF_RES -5))
(defun (nu_0)       (shift OF_RES -4))
(defun (nu_1)       (shift OF_RES -3))
(defun (mu)         (+  (* 2 (mu_1))    (mu_0)))
(defun (nu)         (+  (* 2 (nu_1))    (nu_0)))
;;
(defun (A_HI)       (+  (* THETA (A_3)) (A_2)))
(defun (A_LO)       (+  (* THETA (A_1)) (A_0)))
(defun (B_HI)       (+  (* THETA (B_3)) (B_2)))
(defun (B_LO)       (+  (* THETA (B_1)) (B_0)))
(defun (C_HI)       (+  (* THETA (C_3)) (C_2)))
(defun (C_LO)       (+  (* THETA (C_1)) (C_0)))
