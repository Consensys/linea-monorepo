...
export const YIELD_MANAGER_OPERATIONAL_SAFE_ROLES = [
  ...
  UNPAUSE_NATIVE_YIELD_REPORTING_ROLE,
  PAUSE_LST_WITHDRAWAL_ROLE,
  UNPAUSE_LST_WITHDRAWAL_ROLE,
];

export const YIELD_MANAGER_SECURITY_COUNCIL_ROLES = [...BASE_ROLES, OSSIFIER_ROLE];
