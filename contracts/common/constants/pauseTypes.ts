...
export const NATIVE_YIELD_DONATION_PAUSE_TYPE = 13;
...
export const YIELD_MANAGER_PAUSE_TYPES_ROLES = [
  ...
  { pauseType: NATIVE_YIELD_DONATION_PAUSE_TYPE, role: PAUSE_NATIVE_YIELD_DONATION_ROLE },
];
...
export const YIELD_MANAGER_UNPAUSE_TYPES_ROLES = [
  ...
  { pauseType: NATIVE_YIELD_DONATION_PAUSE_TYPE, role: UNPAUSE_NATIVE_YIELD_DONATION_ROLE },
];
