...
export const SHNARF_SUBMISSION_PAUSE_TYPE = 9;
...
export const LINEA_ROLLUP_PAUSE_TYPES_ROLES = [
  ...
  { pauseType: BLOB_SUBMISSION_PAUSE_TYPE, role: PAUSE_DATA_SUBMISSION_ROLE },
  { pauseType: CALLDATA_SUBMISSION_PAUSE_TYPE, role: PAUSE_DATA_SUBMISSION_ROLE },
...
export const VALIDIUM_PAUSE_TYPES_ROLES = [
  ...
  { pauseType: L1_L2_PAUSE_TYPE, role: PAUSE_L1_L2_ROLE },
  { pauseType: L2_L1_PAUSE_TYPE, role: PAUSE_L2_L1_ROLE },
  { pauseType: SHNARF_SUBMISSION_PAUSE_TYPE, role: PAUSE_DATA_SUBMISSION_ROLE },
  { pauseType: FINALIZATION_PAUSE_TYPE, role: PAUSE_FINALIZATION_ROLE },
];
...
export const LINEA_ROLLUP_UNPAUSE_TYPES_ROLES = [
  ...
  { pauseType: BLOB_SUBMISSION_PAUSE_TYPE, role: UNPAUSE_DATA_SUBMISSION_ROLE },
  { pauseType: CALLDATA_SUBMISSION_PAUSE_TYPE, role: UNPAUSE_DATA_SUBMISSION_ROLE },
...
export const VALIDIUM_UNPAUSE_TYPES_ROLES = [
  ...
  { pauseType: L1_L2_PAUSE_TYPE, role: UNPAUSE_L1_L2_ROLE },
  { pauseType: L2_L1_PAUSE_TYPE, role: UNPAUSE_L2_L1_ROLE },
  { pauseType: SHNARF_SUBMISSION_PAUSE_TYPE, role: UNPAUSE_DATA_SUBMISSION_ROLE },
  { pauseType: FINALIZATION_PAUSE_TYPE, role: UNPAUSE_FINALIZATION_ROLE },
];
