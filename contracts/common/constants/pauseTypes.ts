...
export const NATIVE_YIELD_PERMISSIONLESS_UNSTAKING_PAUSE_TYPE = 11;
export const NATIVE_YIELD_PERMISSIONLESS_REBALANCE_PAUSE_TYPE = 12;
export const NATIVE_YIELD_RESERVE_FUNDING_PAUSE_TYPE = 13;
export const NATIVE_YIELD_REPORTING_PAUSE_TYPE = 14;
export const LST_WITHDRAWAL_PAUSE_TYPE = 15;
...
export const YIELD_MANAGER_PAUSE_TYPES_ROLES = [
  ...
  {
    pauseType: NATIVE_YIELD_PERMISSIONLESS_UNSTAKING_PAUSE_TYPE,
    role: PAUSE_NATIVE_YIELD_PERMISSIONLESS_UNSTAKING_ROLE,
  },
  {
    pauseType: NATIVE_YIELD_PERMISSIONLESS_REBALANCE_PAUSE_TYPE,
    role: PAUSE_NATIVE_YIELD_PERMISSIONLESS_REBALANCE_ROLE,
  },
  {
    pauseType: NATIVE_YIELD_RESERVE_FUNDING_PAUSE_TYPE,
    role: PAUSE_NATIVE_YIELD_RESERVE_FUNDING_ROLE,
  },
  { pauseType: NATIVE_YIELD_REPORTING_PAUSE_TYPE, role: PAUSE_NATIVE_YIELD_REPORTING_ROLE },
  { pauseType: LST_WITHDRAWAL_PAUSE_TYPE, role: PAUSE_LST_WITHDRAWAL_ROLE },
];
...
export const YIELD_MANAGER_UNPAUSE_TYPES_ROLES = [
  ...
  {
    pauseType: NATIVE_YIELD_PERMISSIONLESS_UNSTAKING_PAUSE_TYPE,
    role: UNPAUSE_NATIVE_YIELD_PERMISSIONLESS_UNSTAKING_ROLE,
  },
  {
    pauseType: NATIVE_YIELD_PERMISSIONLESS_REBALANCE_PAUSE_TYPE,
    role: UNPAUSE_NATIVE_YIELD_PERMISSIONLESS_REBALANCE_ROLE,
  },
  {
    pauseType: NATIVE_YIELD_RESERVE_FUNDING_PAUSE_TYPE,
    role: UNPAUSE_NATIVE_YIELD_RESERVE_FUNDING_ROLE,
  },
  { pauseType: NATIVE_YIELD_REPORTING_PAUSE_TYPE, role: UNPAUSE_NATIVE_YIELD_REPORTING_ROLE },
  { pauseType: LST_WITHDRAWAL_PAUSE_TYPE, role: UNPAUSE_LST_WITHDRAWAL_ROLE },
];
