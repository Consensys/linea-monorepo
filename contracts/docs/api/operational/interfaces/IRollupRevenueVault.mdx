...
_Emitted when the V3 DEX contract address is updated._

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| previousValue | address | The previous V3 DEX contract address. |
| newValue | address | The new V3 DEX contract address. |
