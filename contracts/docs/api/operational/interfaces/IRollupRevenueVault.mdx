...
```solidity
event RollupRevenueVaultInitialized(uint256 lastInvoiceDate, address invoicePaymentReceiver, address tokenBridge, address messageService, address l1LineaTokenBurner, address lineaToken, address dex)
```
...
| dex | address | The address of the DEX contract. |
