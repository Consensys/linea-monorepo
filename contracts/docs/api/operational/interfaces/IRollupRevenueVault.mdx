...
| Name | Type | Description |
| ---- | ---- | ----------- |
| newL1LineaTokenBurner | address | The new L1 LINEA token burner contract address. |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| newInvoicePaymentReceiver | address | The new invoice payment receiver address. |
