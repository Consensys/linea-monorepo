...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    mainnet: {
      accounts: [process.env.L1_DEPLOYER_PRIVATE_KEY || EMPTY_HASH],
    ...
    linea_mainnet: {
      accounts: [process.env.L2_DEPLOYER_PRIVATE_KEY || EMPTY_HASH],
    ...
    custom: {
      accounts: [process.env.CUSTOM_DEPLOYER_PRIVATE_KEY || EMPTY_HASH],
