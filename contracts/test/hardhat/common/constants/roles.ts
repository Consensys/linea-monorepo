...
export const PAUSE_DATA_SUBMISSION_ROLE = generateKeccak256(["string"], ["PAUSE_DATA_SUBMISSION_ROLE"], true);
export const UNPAUSE_DATA_SUBMISSION_ROLE = generateKeccak256(["string"], ["UNPAUSE_DATA_SUBMISSION_ROLE"], true);
