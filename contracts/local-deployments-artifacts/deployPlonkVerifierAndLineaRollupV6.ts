...
import {
  LINEA_V6_ROLLUP_PAUSE_TYPES_ROLES,
  LINEA_V6_ROLLUP_UNPAUSE_TYPES_ROLES,
  LINEA_V6_ROLLUP_ROLES,
  OPERATOR_ROLE,
...
async function main() {
  ...
  const pauseTypeRoles = getEnvVarOrDefault("LINEA_ROLLUP_PAUSE_TYPE_ROLES", LINEA_V6_ROLLUP_PAUSE_TYPES_ROLES);
  const unpauseTypeRoles = getEnvVarOrDefault("LINEA_ROLLUP_UNPAUSE_TYPE_ROLES", LINEA_V6_ROLLUP_UNPAUSE_TYPES_ROLES);
  const defaultRoleAddresses = generateRoleAssignments(LINEA_V6_ROLLUP_ROLES, lineaRollupSecurityCouncil, [
