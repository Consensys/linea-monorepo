...
contract OpcodeTester {
  ...
  function executeG2BLSPrecompiles() external {
    ...
    require(returnData.length == 256, "BLS12_G2ADD failed");
    ...
    require(returnData.length == 0, "BLS12_G2ADD failed");
    ...
    require(returnData.length == 256, "BLS12_G2MSM failed");
  ...
  function executePrecompiles() external {
    ...
    require(validP256VerifyOutput == bytes32(uint256(1)), "P256VERIFY failed for valid input");
    ...
    require(returnData.length == 0, "P256VERIFY failed for valid input");
    ...
    require(returnData.length == 64, "POINT OF EVALUATION failed");
    ...
    require(returnData.length == 0, "POINT OF EVALUATION failed");
    ...
    require(returnData.length == 32, "BLS12_PAIRING_CHECK failed");
    ...
    require(returnData.length == 128, "BLS12_MAP_FP_TO_G1 failed");
    ...
    require(returnData.length == 256, "BLS12_MAP_FP2_TO_G2 failed");
  }
}
