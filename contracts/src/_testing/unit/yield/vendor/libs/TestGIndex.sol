...
import { GIndex, pack as gindexPack, unwrap as gindexUnwrap, index as gindexIndex, width as gindexWidth, concat as gindexConcat, shr as gindexShr, shl as gindexShl, pow as gindexPow, fls as gindexFls } from "../../../../../yield/libs/vendor/lido/GIndex.sol";
...
contract TestGIndex {
  ...
  function isRoot(GIndex gIndex) external pure returns (bool) {
    return gindexIndex(gIndex) == 1 && gindexPow(gIndex) == 0;
  }
