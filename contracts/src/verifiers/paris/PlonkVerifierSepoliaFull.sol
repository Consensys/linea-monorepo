...
contract PlonkVerifierSepoliaFull {
  ...
  uint256 private constant VK_QL_COM_X = 10494739859364837742682663071793774521096017657490791299588913611405381070619;
  uint256 private constant VK_QL_COM_Y = 21172470377197632607511110193877210689970276509514933866185966662415213044035;
  uint256 private constant VK_QR_COM_X = 21885292462356579629423050461603007776339151433480508104067097292876830621495;
  uint256 private constant VK_QR_COM_Y = 7861506396916632261500652604371737342527197299767440809161768436655967415008;
  uint256 private constant VK_QM_COM_X = 12773157922083398283143735130889859271361189449405101398056106523149674451871;
  uint256 private constant VK_QM_COM_Y = 987738351528605886781083738028734609862093498371543948633901144283463821417;
  uint256 private constant VK_QO_COM_X = 18737596138555710069684094698671620619310869098817087443934965044508238682889;
  uint256 private constant VK_QO_COM_Y = 4064203227871147751164884047168404821373804507837426655584454480819201138423;
  uint256 private constant VK_QK_COM_X = 14090937670980658763829101377796903152715402541984369019047446820055771579596;
  uint256 private constant VK_QK_COM_Y = 1709791747622863147430266250770506393580956318600874785648706864762184624751;
  
  uint256 private constant VK_S1_COM_X = 13346701778953788319452786225048536663980258481795686550775015002757121597756;
  uint256 private constant VK_S1_COM_Y = 1597469918679882050110334017940223042140039942369227608135657700307141951112;
  
  uint256 private constant VK_S2_COM_X = 20743368715346343772814253514607804832864110454026734992897395996659519501891;
  uint256 private constant VK_S2_COM_Y = 14654266348934460383486596442282646401525451428127866934782875674324421408733;
  
  uint256 private constant VK_S3_COM_X = 18170154518658305783071541540651793894966645235749265045803290961954930788020;
  uint256 private constant VK_S3_COM_Y = 8812259819597926217824427670639379974965755010701484970209294480294324166239;
  
  uint256 private constant VK_COSET_SHIFT = 5;
  
  
  uint256 private constant VK_QCP_0_X = 21353599270552508921339203860695558699842824658244804060407303045602521564947;
  uint256 private constant VK_QCP_0_Y = 20356972213829872644260849798473818013881353540768023129342814220120040166901;
  
  
  uint256 private constant VK_INDEX_COMMIT_API_0 = 8603174;
