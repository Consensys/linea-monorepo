...
contract PlonkVerifierFull is IPlonkVerifier {
  ...
  uint256 private constant VK_QL_COM_X = 18545203263553755343320810580221474767833131911591103364058267121224968846457;
  uint256 private constant VK_QL_COM_Y = 15071095136043149958833746850634355629691701173832332682796150728239227827668;
  uint256 private constant VK_QR_COM_X = 1534168053644044048177751303322985480454272979314323980449017354969860629496;
  uint256 private constant VK_QR_COM_Y = 9299059926577194771777004773569885995399541930255741323309717025778032862310;
  uint256 private constant VK_QM_COM_X = 5321541454528032211898800636592556742437322400791342348906972564129084995531;
  uint256 private constant VK_QM_COM_Y = 19799218152890622969621282271242993355409874328662266926286614816384479931194;
  uint256 private constant VK_QO_COM_X = 16253025539671624779817961139953387004156574072941097078960630540727213918299;
  uint256 private constant VK_QO_COM_Y = 15568021168203898944578503093655409685567188363576718719049935877499428257501;
  uint256 private constant VK_QK_COM_X = 2968213794493026448513189426858082949052789394696895482349592170306959320101;
  uint256 private constant VK_QK_COM_Y = 20914668026157455109268863341286260490610959315990011830217455412952742600049;

  uint256 private constant VK_S1_COM_X = 20883577179949985716249851284853573985444733130689876985718862044856173889428;
  uint256 private constant VK_S1_COM_Y = 20342425285620341998287893640425253742482679419646375913386380215528369043337;

  uint256 private constant VK_S2_COM_X = 13346975624625355546076256838091874482068881931953456793066833313440508919222;
  uint256 private constant VK_S2_COM_Y = 11374842388421812673126530866775819740525684374150545071761483252247445319266;

  uint256 private constant VK_S3_COM_X = 4969034480229523469464339244411314215353610604323474731246148481085146880641;
  uint256 private constant VK_S3_COM_Y = 12480861098223244438258076024527669469758093718362584167439333034658617149570;

  uint256 private constant VK_COSET_SHIFT = 5;

  uint256 private constant VK_QCP_0_X = 20971966817946599520702133365554382140184425975914525485569526211105332953117;
  uint256 private constant VK_QCP_0_Y = 17217490912366851049372231468301970268030282461088172548439396066187101804447;

  uint256 private constant VK_INDEX_COMMIT_API_0 = 6161597;
  ...
  /// @notice Compute the chain configuration hash.
  /// @param _chainConfiguration The chain configuration parameters.
