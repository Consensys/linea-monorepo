...
// RPC_URL=<> L1_DEPLOYER_PRIVATE_KEY=<> TARGET_ADDRESS=<> npx hardhat run scripts/testEIP7702/sendType4Tx.ts
...
class EIP7702TransactionSender {
  ...
  // Create Authorization for process.env.L1_DEPLOYER_PRIVATE_KEY
