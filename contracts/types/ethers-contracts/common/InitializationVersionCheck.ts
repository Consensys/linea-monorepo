...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "../common.js"
  ...
  export interface InitializationVersionCheckInterface extends Interface {
  ...
  export interface InitializationVersionCheck extends BaseContract {
    
    connect(runner?: ContractRunner | null): InitializationVersionCheck;
    waitForDeployment(): Promise<this>;

    interface: InitializationVersionCheckInterface;
