...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../common.js"
  ...
  export interface IGenericErrorsInterface extends Interface {
  ...
  export interface IGenericErrors extends BaseContract {
    
    connect(runner?: ContractRunner | null): IGenericErrors;
    waitForDeployment(): Promise<this>;

    interface: IGenericErrorsInterface;
