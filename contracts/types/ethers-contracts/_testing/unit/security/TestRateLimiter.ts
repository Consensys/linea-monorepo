...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../../common.js"
  ...
  export interface TestRateLimiterInterface extends Interface {
    getFunction(nameOrSignature: "DEFAULT_ADMIN_ROLE" | "RATE_LIMIT_SETTER_ROLE" | "USED_RATE_LIMIT_RESETTER_ROLE" | "currentPeriodAmountInWei" | "currentPeriodEnd" | "getRoleAdmin" | "grantRole" | "hasRole" | "initialize" | "limitInWei" | "periodInSeconds" | "renounceRole" | "resetAmountUsedInPeriod" | "resetRateLimitAmount" | "revokeRole" | "supportsInterface" | "tryInitialize" | "withdrawSomeAmount"): FunctionFragment;
...
encodeFunctionData(functionFragment: 'withdrawSomeAmount', values: [BigNumberish]): string;
...
decodeFunctionResult(functionFragment: 'withdrawSomeAmount', data: BytesLike): Result;
  }
  ...
  export interface TestRateLimiter extends BaseContract {
    
    connect(runner?: ContractRunner | null): TestRateLimiter;
    waitForDeployment(): Promise<this>;

    interface: TestRateLimiterInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    initialize: TypedContractMethod<
      [_periodInSeconds: BigNumberish, _limitInWei: BigNumberish, ],
      [void],
      'nonpayable'
    >
    ...
    withdrawSomeAmount: TypedContractMethod<
      [_amount: BigNumberish, ],
      [void],
      'nonpayable'
    >
...
getFunction(nameOrSignature: 'tryInitialize'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'withdrawSomeAmount'): TypedContractMethod<
      [_amount: BigNumberish, ],
      [void],
      'nonpayable'
    >;
