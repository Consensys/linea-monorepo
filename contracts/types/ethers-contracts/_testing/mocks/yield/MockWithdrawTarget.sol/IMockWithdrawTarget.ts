...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../../../common.js"
  ...
  export interface IMockWithdrawTargetInterface extends Interface {
  ...
  export interface IMockWithdrawTarget extends BaseContract {
    
    connect(runner?: ContractRunner | null): IMockWithdrawTarget;
    waitForDeployment(): Promise<this>;

    interface: IMockWithdrawTargetInterface;
