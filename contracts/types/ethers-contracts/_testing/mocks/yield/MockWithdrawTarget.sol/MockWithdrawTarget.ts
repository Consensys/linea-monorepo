...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../../../common.js"
  ...
  export interface MockWithdrawTargetInterface extends Interface {
  ...
  export interface MockWithdrawTarget extends BaseContract {
    
    connect(runner?: ContractRunner | null): MockWithdrawTarget;
    waitForDeployment(): Promise<this>;

    interface: MockWithdrawTargetInterface;
