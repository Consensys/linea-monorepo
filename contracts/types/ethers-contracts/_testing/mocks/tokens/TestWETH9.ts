...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../../common.js"
  ...
  export interface TestWETH9Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'withdraw', data: BytesLike): Result;
    ...
    export namespace ApprovalEvent {
      export type InputTuple = [src: AddressLike, guy: AddressLike, wad: BigNumberish];
      export type OutputTuple = [src: string, guy: string, wad: bigint];
      export interface OutputObject {src: string, guy: string, wad: bigint };
    ...
    export namespace DepositEvent {
      ...
      export interface OutputObject {dst: string, wad: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace TransferEvent {
      export type InputTuple = [src: AddressLike, dst: AddressLike, wad: BigNumberish];
      export type OutputTuple = [src: string, dst: string, wad: bigint];
      export interface OutputObject {src: string, dst: string, wad: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace WithdrawalEvent {
      ...
      export interface OutputObject {src: string, wad: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  export interface TestWETH9 extends BaseContract {
    ...
    connect(runner?: ContractRunner | null): TestWETH9;
