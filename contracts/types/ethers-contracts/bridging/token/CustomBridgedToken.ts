...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface CustomBridgedTokenInterface extends Interface {
    getFunction(nameOrSignature: "DOMAIN_SEPARATOR" | "_decimals" | "allowance" | "approve" | "balanceOf" | "bridge" | "burn" | "decimals" | "decreaseAllowance" | "eip712Domain" | "increaseAllowance" | "initialize" | "initializeV2" | "mint" | "name" | "nonces" | "permit" | "symbol" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;
...
encodeFunctionData(functionFragment: 'initializeV2', values: [string, string, BigNumberish, AddressLike]): string;
...
decodeFunctionResult(functionFragment: 'transferFrom', data: BytesLike): Result;
  ...
  export interface CustomBridgedToken extends BaseContract {
    
    connect(runner?: ContractRunner | null): CustomBridgedToken;
    waitForDeployment(): Promise<this>;

    interface: CustomBridgedTokenInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    initialize: TypedContractMethod<
      [_tokenName: string, _tokenSymbol: string, _tokenDecimals: BigNumberish, ],
      [void],
      'nonpayable'
    >
    ...
    initializeV2: TypedContractMethod<
      [_tokenName: string, _tokenSymbol: string, _tokenDecimals: BigNumberish, _bridge: AddressLike, ],
      [void],
      'nonpayable'
    >
    ...
    getFunction(nameOrSignature: 'DOMAIN_SEPARATOR'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: '_decimals'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
