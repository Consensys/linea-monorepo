...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../common.js"
  ...
  export interface IZkEvmV2Interface extends Interface {
  ...
  export interface IZkEvmV2 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IZkEvmV2;
    waitForDeployment(): Promise<this>;

    interface: IZkEvmV2Interface;
