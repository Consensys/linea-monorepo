...
/**
 * Precompiled net.consensys.zkevm.linea-contracts-helper script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class NetConsensysZkevmLineaContractsHelperPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_NetConsensysZkevmLineaContractsHelper").asSubclass(BasicScript.class);
