...
/**
 * Precompiled net.consensys.zkevm.linea-native-libs-helper script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class NetConsensysZkevmLineaNativeLibsHelperPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_NetConsensysZkevmLineaNativeLibsHelper").asSubclass(BasicScript.class);
