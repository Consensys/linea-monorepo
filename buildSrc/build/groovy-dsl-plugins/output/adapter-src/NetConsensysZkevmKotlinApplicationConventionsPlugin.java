...
/**
 * Precompiled net.consensys.zkevm.kotlin-application-conventions script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class NetConsensysZkevmKotlinApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_NetConsensysZkevmKotlinApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("net.consensys.zkevm.kotlin-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_NetConsensysZkevmKotlinApplicationConventions").asSubclass(BasicScript.class);
