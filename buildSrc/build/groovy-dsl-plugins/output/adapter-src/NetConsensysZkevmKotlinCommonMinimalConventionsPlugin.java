...
/**
 * Precompiled net.consensys.zkevm.kotlin-common-minimal-conventions script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class NetConsensysZkevmKotlinCommonMinimalConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_NetConsensysZkevmKotlinCommonMinimalConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_NetConsensysZkevmKotlinCommonMinimalConventions").asSubclass(BasicScript.class);
