...
/**
 * Precompiled net.consensys.zkevm.kotlin-library-minimal-conventions script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class NetConsensysZkevmKotlinLibraryMinimalConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_NetConsensysZkevmKotlinLibraryMinimalConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("net.consensys.zkevm.kotlin-common-minimal-conventions");
            target.getPluginManager().apply("java-library");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_NetConsensysZkevmKotlinLibraryMinimalConventions").asSubclass(BasicScript.class);
