...
class JsonParserHelper {
  ...
  companion object {
    ...
    var mapOfValues: Map<String, TracingModule> = mapOf(
      "add" to TracingModule.ADD,
      "bin" to TracingModule.BIN,
      "binRT" to TracingModule.BIN_RT,
      "ext" to TracingModule.EXT,
      "ec_data" to TracingModule.EC_DATA,
      "hash_data" to TracingModule.PUB_HASH,
      "hash_info" to TracingModule.PUB_HASH_INFO,
      "hub" to TracingModule.HUB,
      "log_data" to TracingModule.PUB_LOG,
      "log_info" to TracingModule.PUB_LOG_INFO,
      "mmio" to TracingModule.MMIO,
      "mmu" to TracingModule.MMU,
      "mmuID" to TracingModule.MMU_ID,
      "mod" to TracingModule.MOD,
      "mul" to TracingModule.MUL,
      "mxp" to TracingModule.MXP,
      "phoneyRLP" to TracingModule.PHONEY_RLP,
      "rlp" to TracingModule.RLP,
      "rom" to TracingModule.ROM,
      "shf" to TracingModule.SHF,
      "shfRT" to TracingModule.SHF_RT,
      "txRlp" to TracingModule.TX_RLP,
      "wcp" to TracingModule.WCP
    )

    fun from(key: String): TracingModule? {
