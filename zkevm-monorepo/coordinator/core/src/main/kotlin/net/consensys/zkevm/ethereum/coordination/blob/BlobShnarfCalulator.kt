...
import net.consensys.linea.nativecompressor.GoNativeBlobShnarfCalculator
import net.consensys.linea.nativecompressor.GoNativeShnarfCalculatorFactory
...
class GoBackedBlobShnarfCalculator(
  private val delegate: GoNativeBlobShnarfCalculator = GoNativeShnarfCalculatorFactory.getInstance()
