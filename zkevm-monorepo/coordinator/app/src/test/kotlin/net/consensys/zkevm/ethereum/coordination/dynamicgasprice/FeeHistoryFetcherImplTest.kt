  ...
  private fun createMockedWeb3jBlobExtended(): Web3jBlobExtended {
    ...
    whenever(
      ...
      .thenAnswer {
        ...
        feeHistory.reward = (1000 until 1010).map { listOf(it.toString()) }
        feeHistory.baseFeePerGas = (10000 until 10011).map { it.toString() }
        feeHistory.gasUsedRatio = (10 until 20).map { it / 100.0 }
        feeHistory.baseFeePerBlobGas = (10000 until 10011).map { it.toString() }
        feeHistory.blobGasUsedRatio = (10 until 20).map { it / 100.0 }
