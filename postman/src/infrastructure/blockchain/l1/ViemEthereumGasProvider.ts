...
import type { IGasProvider, DefaultGasProviderConfig } from "../../../domain/ports/IGasProvider";
import type { GasFees } from "../../../domain/types/blockchain";

export class ViemEthereumGasProvider implements IGasProvider {
