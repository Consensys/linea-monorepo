 ...
 */
contract L2LineaToken is ERC20Upgradeable, AccessControlUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable, MessageServiceBase, IL2LineaToken {
   ...
   */
  function syncTotalSupplyFromL1(uint256 _l1LineaTokenTotalSupplySyncTime, uint256 _l1LineaTokenSupply)
    external
   ...
   */
  function nonces(address _owner) public view virtual override(ERC20PermitUpgradeable, NoncesUpgradeable) returns (uint256) {
   ...
   */
  function _update(address _from, address _to, uint256 _value) internal virtual override(ERC20Upgradeable, ERC20VotesUpgradeable) {
