...
contract LineaTokenTest is Test {
  ...
  function setUp() public virtual {
    ...
    bytes memory data = abi.encodeWithSelector(LineaToken.initialize.selector, admin, minter, l1MessageService, l2TokenAddress, tokenName, tokenSymbol);
  ...
  function test_shouldEmitL2TokenAddressSetOnInitialize() public {
    ...
    bytes memory data = abi.encodeWithSelector(LineaToken.initialize.selector, admin, minter, localL1MessageService, l2TokenAddress, tokenName, tokenSymbol);
  ...
  function test_shouldRevertWhenTokenNameIsEmpty() public {
    ...
    bytes memory data = abi.encodeWithSelector(LineaToken.initialize.selector, admin, minter, l1MessageService, l2TokenAddress, "", tokenSymbol);
  ...
  function test_shouldRevertWhenTokenSymbolIsEmpty() public {
    ...
    bytes memory data = abi.encodeWithSelector(LineaToken.initialize.selector, admin, minter, l1MessageService, l2TokenAddress, tokenName, "");
  ...
  function test_shouldRevertWhenDefaultAdminIsZeroAddress() public {
    ...
    bytes memory data = abi.encodeWithSelector(LineaToken.initialize.selector, defaultAdmin, minter, l1MessageService, l2TokenAddress, tokenName, tokenSymbol);
  ...
  function test_shouldRevertWhenMinterIsZeroAddress() public {
    ...
    bytes memory data = abi.encodeWithSelector(LineaToken.initialize.selector, admin, minterAddress, l1MessageService, l2TokenAddress, tokenName, tokenSymbol);
  ...
  function test_shouldRevertWhenL1MessageServiceIsZeroAddress() public {
    ...
    bytes memory data = abi.encodeWithSelector(LineaToken.initialize.selector, admin, minter, l1MessageServiceAddress, l2TokenAddress, tokenName, tokenSymbol);
  ...
  function test_shouldRevertWhenL2TokenAddressIsZeroAddress() public {
    ...
    bytes memory data = abi.encodeWithSelector(LineaToken.initialize.selector, admin, minter, l1MessageService, l2Token, tokenName, tokenSymbol);
