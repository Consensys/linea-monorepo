...
contract L2LineaTokenTest is Test {
  ...
  function setUp() public virtual {
    ...
    bytes memory data =
      abi.encodeWithSelector(L2LineaToken.initialize.selector, admin, lineaCanonicalTokenBridge, lineaMessageServiceAddress, l1Token, tokenName, tokenSymbol);
  ...
  function test_shouldEmitL1TokenAddressSetOnInitialize() public {
    ...
    bytes memory data =
      abi.encodeWithSelector(L2LineaToken.initialize.selector, admin, lineaCanonicalTokenBridge, localLineaMessageService, l1Token, tokenName, tokenSymbol);
  ...
  function test_shouldNotInitializeTwice() public {
    ...
    tokenProxy.initialize(admin, lineaCanonicalTokenBridge, lineaMessageServiceAddress, l1Token, tokenName, tokenSymbol);
  }
  ...
  function test_shouldRevertWhenTokenNameIsEmpty() public {
    ...
    bytes memory data =
      abi.encodeWithSelector(L2LineaToken.initialize.selector, admin, lineaCanonicalTokenBridge, lineaMessageServiceAddress, l1Token, "", tokenSymbol);
  ...
  function test_shouldRevertWhenTokenSymbolIsEmpty() public {
    ...
    bytes memory data =
      abi.encodeWithSelector(L2LineaToken.initialize.selector, admin, lineaCanonicalTokenBridge, lineaMessageServiceAddress, l1Token, tokenName, "");
  ...
  function test_shouldRevertWhenDefaultAdminIsZeroAddress() public {
    ...
    bytes memory data = abi.encodeWithSelector(
      L2LineaToken.initialize.selector, defaultAdmin, lineaCanonicalTokenBridge, lineaMessageServiceAddress, l1Token, tokenName, tokenSymbol
    );
  ...
  function test_shouldRevertWhenLineaCanonicalTokenBridgeIsZeroAddress() public {
    ...
    bytes memory data = abi.encodeWithSelector(
      L2LineaToken.initialize.selector, admin, lineaCanonicalTokenBridgeAddress, lineaMessageServiceAddress, l1Token, tokenName, tokenSymbol
    );
  ...
  function test_shouldRevertWhenL2MessageServiceIsZeroAddress() public {
    ...
    bytes memory data =
      abi.encodeWithSelector(L2LineaToken.initialize.selector, admin, lineaCanonicalTokenBridge, lineaMessageServiceEmpty, l1Token, tokenName, tokenSymbol);
  ...
  function test_shouldRevertWhenL1TokenIsZeroAddress() public {
    ...
    bytes memory data = abi.encodeWithSelector(
      L2LineaToken.initialize.selector, admin, lineaCanonicalTokenBridge, lineaMessageServiceAddress, l1TokenAddress, tokenName, tokenSymbol
    );
  ...
  function test_shouldRevertWhenSenderIsNotAuthorized() public {
    ...
    bytes memory data = abi.encodeCall(L2LineaToken.syncTotalSupplyFromL1, (l1LineaTokenTotalSupplySyncTime, l1LineaTokenSupply));
  ...
  function test_shouldFailOnOldSync() public {
    ...
    data = abi.encodeCall(L2LineaToken.syncTotalSupplyFromL1, (l1LineaTokenTotalSupplySyncTime - 1, l1LineaTokenSupply));
