import { Overrides, ContractTransactionResponse } from "ethers";
...
export class L1ClaimingService {
   ...
   */
  constructor(
    public readonly l1ContractClient: ILineaRollupClient<Overrides, ContractTransactionResponse>,
  ...
  public async estimateClaimMessageGas(
    ...
    if (!isClaimingNeedingProof) {
      return this.l1ContractClient.estimateClaimWithoutProofGas(message, overrides);
    }

    return this.l1ContractClient.estimateClaimGas(message, overrides);
  }
