...
class BlobScanClientTest {
  ...
  private lateinit var restClient: VertxRestClient<JsonObject>
  ...
  fun setUp(vertx: Vertx) {
    ...
    restClient = VertxRestClient(
      vertx = vertx,
      webClient = WebClient.create(vertx, WebClientOptions().setDefaultsFrom(serverURI)),
    ...
    blobScanClient = BlobScanClient(restClient)
  }
