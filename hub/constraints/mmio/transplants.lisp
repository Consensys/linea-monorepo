...
(defconstraint store-X-in-A-three-required ()
                (if-eq MICRO_INSTRUCTION StoreXInAThreeRequired
                    (begin
                        ...
                        (= VAL_A VAL_X)
                        (remains-constant VAL_A)
                        (remains-constant VAL_B)
                        (remains-constant VAL_C)

                        (vanishes VAL_A_NEW)            ;; TODO remove
                        (vanishes VAL_B_NEW)            ;; TODO remove
                        (vanishes VAL_C_NEW)            ;; TODO remove
                        (remains-constant VAL_A_NEW)    ;; TODO remove
                        (remains-constant VAL_B_NEW)    ;; TODO remove
                        (remains-constant VAL_C_NEW)    ;; TODO remove
                        (= ERF 1)                       ;; TODO remove
                        (= FAST 1))))                   ;; TODO remove 
