...
;;
(defun (copy-instruction---OOB-raises-return-data-exception)         (shift [misc/OOB_DATA 7]    ROW_OFFSET_COPY_INST_MISCELLANEOUS_ROW)) ;; ""
(defun (copy-instruction---MXP-raises-memory-expansion-exception)    (shift misc/MXP_MXPX        ROW_OFFSET_COPY_INST_MISCELLANEOUS_ROW))
(defun (copy-instruction---MXP-memory-expansion-gas)                 (shift misc/MXP_GAS_MXP     ROW_OFFSET_COPY_INST_MISCELLANEOUS_ROW))

;; call data related
(defun (copy-instruction---call-data-context)    (shift context/CALL_DATA_CONTEXT_NUMBER    ROW_OFFSET_CALLDATACOPY_CONTEXT_ROW))
(defun (copy-instruction---call-data-offset)     (shift context/CALL_DATA_OFFSET            ROW_OFFSET_CALLDATACOPY_CONTEXT_ROW))
(defun (copy-instruction---call-data-size)       (shift context/CALL_DATA_SIZE              ROW_OFFSET_CALLDATACOPY_CONTEXT_ROW))

;; return data related
(defun (copy-instruction---return-data-context)    (shift context/RETURN_DATA_CONTEXT_NUMBER    ROW_OFFSET_RETURNDATACOPY_CURRENT_CONTEXT_ROW))
(defun (copy-instruction---return-data-offset)     (shift context/RETURN_DATA_OFFSET            ROW_OFFSET_RETURNDATACOPY_CURRENT_CONTEXT_ROW))
(defun (copy-instruction---return-data-size)       (shift context/RETURN_DATA_SIZE              ROW_OFFSET_RETURNDATACOPY_CURRENT_CONTEXT_ROW))

;; for ext code copy
(defun (copy-instruction---current-address-code-fragment-index)    (shift account/CODE_FRAGMENT_INDEX    ROW_OFFSET_CODECOPY_NO_XAHOY_ACCOUNT_ROW))
(defun (copy-instruction---current-address-code-size)              (shift account/CODE_SIZE              ROW_OFFSET_CODECOPY_NO_XAHOY_ACCOUNT_ROW))

;;
(defun (copy-instruction---exo-address-warmth)                 (shift account/WARMTH                 ROW_OFFSET_EXTCODECOPY_NO_XAHOY_ACCOUNT_ROW))
(defun (copy-instruction---exo-address-has-code)               (shift account/HAS_CODE               ROW_OFFSET_EXTCODECOPY_NO_XAHOY_ACCOUNT_ROW))
(defun (copy-instruction---exo-address-code-size)              (shift account/CODE_SIZE              ROW_OFFSET_EXTCODECOPY_NO_XAHOY_ACCOUNT_ROW))
(defun (copy-instruction---exo-address-code-fragment-index)    (shift account/CODE_FRAGMENT_INDEX    ROW_OFFSET_EXTCODECOPY_NO_XAHOY_ACCOUNT_ROW))
...
(defun (copy-instruction---trigger_MMU)    (* (- 1 XAHOY) (shift misc/MXP_MTNTOP ROW_OFFSET_COPY_INST_MISCELLANEOUS_ROW)))
