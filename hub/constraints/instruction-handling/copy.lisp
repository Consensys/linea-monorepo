...
(defconstraint copy-allowable-exceptions (:guard (copy-inst-standard-precondition));; TODO: make debug
  (eq! XAHOY
       (+ (* (copy-inst-is-RETURNDATACOPY) stack/RDCX) stack/MXPX stack/OOGX)))
  ...
  (begin (eq! NSR
         ...
         (if-zero XAHOY
                  (if-not-zero CONTEXT_WILL_REVERT
                               ...
                               (eq! NSR
                                    (+ (shift PEEK_AT_MISCELLANEOUS ROW_OFFSET_COPY_INST_MISCELLANEOUS_ROW)
                                       (shift PEEK_AT_ACCOUNT
                                              ROW_OFFSET_EXTCODECOPY_NO_XAHOY_REVERT_ACCOUNT_DOING_ROW)
                                       (shift PEEK_AT_ACCOUNT
                                              ROW_OFFSET_EXTCODECOPY_NO_XAHOY_REVERT_ACCOUNT_UNDOING_ROW)))
                               ;; CN_WILL_REV ≡ 0
                               (eq! NSR
                                    (+ (shift PEEK_AT_MISCELLANEOUS ROW_OFFSET_COPY_INST_MISCELLANEOUS_ROW)
                                       (shift PEEK_AT_ACCOUNT
                                              ROW_OFFSET_EXTCODECOPY_NO_XAHOY_NO_REVERT_ACCOUNT_ROW)))))))
...
(defun (copy-inst-source-id)
  (+ (* (copy-inst-is-CALLDATACOPY) (copy-inst-call-data-context))
...
(defun (copy-inst-reference-offset)
  (+ (* (copy-inst-is-CALLDATACOPY) (copy-inst-call-data-offset))
     (* (copy-inst-is-RETURNDATACOPY) (copy-inst-return-data-offset))))

(defun (copy-inst-reference-size)
  (+ (* (copy-inst-is-CALLDATACOPY) (copy-inst-call-data-size))
     ...
     (* (copy-inst-is-EXTCODECOPY)
        (* (copy-inst-exo-address-code-fragment-index) (copy-inst-exo-address-has-code)))))

(defun (copy-inst-exo-sum)
  (* (+ (copy-inst-is-CODECOPY) (copy-inst-is-EXTCODECOPY)) EXO_SUM_WEIGHT_ROM))
...
(defconstraint copy-setting-the-account-row-for-unexceptional-CODECOPY (:guard (copy-inst-standard-CODECOPY))
               (if-zero XAHOY
                        (begin (eq! (shift account/ADDRESS_HI ROW_OFFSET_CODECOPY_NO_XAHOY_ACCOUNT_ROW)
                                    (shift context/BYTE_CODE_ADDRESS_HI ROW_OFFSET_CODECOPY_NO_XAHOY_CONTEXT_ROW))
                               (eq! (shift account/ADDRESS_LO ROW_OFFSET_CODECOPY_NO_XAHOY_ACCOUNT_ROW)
                                    (shift context/BYTE_CODE_ADDRESS_LO ROW_OFFSET_CODECOPY_NO_XAHOY_CONTEXT_ROW))
                               (eq! (shift account/DEPLOYMENT_NUMBER ROW_OFFSET_CODECOPY_NO_XAHOY_ACCOUNT_ROW)
                                    (shift context/BYTE_CODE_CODE_FRAGMENT_INDEX ROW_OFFSET_CODECOPY_NO_XAHOY_CONTEXT_ROW))
                               (eq! (shift account/CODE_FRAGMENT_INDEX ROW_OFFSET_CODECOPY_NO_XAHOY_ACCOUNT_ROW)
                                    CODE_FRAGMENT_INDEX)
...
(defconstraint copy-the-OOGX-case-for-EXTCODECOPY (:guard (copy-inst-standard-EXTCODECOPY))
               (if-not-zero stack/OOGX
                            ;; account-row i + 2
                            (begin (account-trim-address ROW_OFFSET_EXTCODECOPY_OOGX_ACCOUNT_ROW
...
(defconstraint copy-inst-unexceptional-reverted-EXTCODECOPY-doing-account-row (:guard (copy-inst-standard-EXTCODECOPY))
               (if-not-zero (* (- 1 XAHOY) CONTEXT_WILL_REVERT)
                            (begin (account-trim-address ROW_OFFSET_EXTCODECOPY_OOGX_ACCOUNT_ROW
                                                         (copy-inst-raw-address-hi)
                                                         (copy-inst-raw-address-lo))
                                   (eq! (shift account/ROMLEX_FLAG
                                               ROW_OFFSET_EXTCODECOPY_NO_XAHOY_REVERT_ACCOUNT_DOING_ROW)
                                        (copy-inst-trigger-CFI))
...
(defconstraint copy-inst-unexceptional-reverted-EXTCODECOPY-undoing-account-row (:guard (copy-inst-standard-EXTCODECOPY))
               (if-not-zero (* (- 1 XAHOY) CONTEXT_WILL_REVERT)
                            (begin (account-same-address-as ROW_OFFSET_EXTCODECOPY_NO_XAHOY_REVERT_ACCOUNT_UNDOING_ROW
                                                            ROW_OFFSET_EXTCODECOPY_NO_XAHOY_REVERT_ACCOUNT_DOING_ROW)
                                   (debug (eq! (shift account/ROMLEX_FLAG
                                                      ROW_OFFSET_EXTCODECOPY_NO_XAHOY_REVERT_ACCOUNT_UNDOING_ROW)
                                               0))
                                   (account-undo-balance-update ROW_OFFSET_EXTCODECOPY_NO_XAHOY_REVERT_ACCOUNT_UNDOING_ROW
                                                                ROW_OFFSET_EXTCODECOPY_NO_XAHOY_REVERT_ACCOUNT_DOING_ROW)
                                   (account-undo-nonce-update ROW_OFFSET_EXTCODECOPY_NO_XAHOY_REVERT_ACCOUNT_UNDOING_ROW
                                                              ROW_OFFSET_EXTCODECOPY_NO_XAHOY_REVERT_ACCOUNT_DOING_ROW)
                                   (account-undo-code-update ROW_OFFSET_EXTCODECOPY_NO_XAHOY_REVERT_ACCOUNT_UNDOING_ROW
                                                             ROW_OFFSET_EXTCODECOPY_NO_XAHOY_REVERT_ACCOUNT_DOING_ROW)
                                   (account-undo-deployment-status-update ROW_OFFSET_EXTCODECOPY_NO_XAHOY_REVERT_ACCOUNT_UNDOING_ROW
                                                                          ROW_OFFSET_EXTCODECOPY_NO_XAHOY_REVERT_ACCOUNT_DOING_ROW)
                                   (account-undo-warmth-update ROW_OFFSET_EXTCODECOPY_NO_XAHOY_REVERT_ACCOUNT_UNDOING_ROW
                                                               ROW_OFFSET_EXTCODECOPY_NO_XAHOY_REVERT_ACCOUNT_DOING_ROW)
...
(defconstraint copy-inst-unexceptional-unreverted-EXTCODECOPY-account-row (:guard (copy-inst-standard-EXTCODECOPY))
               (if-not-zero (* (- 1 XAHOY) (- 1 CONTEXT_WILL_REVERT))
                            (begin (account-trim-address ROW_OFFSET_EXTCODECOPY_NO_XAHOY_NO_REVERT_ACCOUNT_ROW
                                                         (copy-inst-raw-address-hi)
                                                         (copy-inst-raw-address-lo))
                                   (eq! (shift account/ROMLEX_FLAG ROW_OFFSET_EXTCODECOPY_NO_XAHOY_NO_REVERT_ACCOUNT_ROW)
                                        (copy-inst-trigger-CFI))
