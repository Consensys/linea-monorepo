...
(defun    (precompile-scenario-row-setting    relative_row_offset)
  (begin
    ...
    (eq!    (shift    scenario/PRC_CDO                                     relative_row_offset)    (call-instruction---STACK-cdo-lo))
    (eq!    (shift    scenario/PRC_CDS                                     relative_row_offset)    (call-instruction---STACK-cds-lo))
    (eq!    (shift    scenario/PRC_RAO                                     relative_row_offset)    (call-instruction---STACK-r@o-lo))
    (eq!    (shift    scenario/PRC_RAC                                     relative_row_offset)    (call-instruction---STACK-r@c-lo))
    ))
