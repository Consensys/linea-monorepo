...
;; unexceptional yet aborted CALL
(defun    (call-instruction---flag-sum-abort)                        (+    (call-instruction---extended-call-prefix)
                                                                           (shift    PEEK_AT_CONTEXT    CALL_abort_update_current_context_row___row_offset)
                                                                           ))
