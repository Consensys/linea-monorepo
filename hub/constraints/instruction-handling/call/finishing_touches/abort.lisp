...
(defconstraint    call-instruction---unexceptional-aborted-CALL-will-revert---undoing-callee-warmth-update    (:guard    (*    PEEK_AT_SCENARIO    scenario/CALL_ABORT_WILL_REVERT))
                  (begin
...
(defconstraint    call-instruction---unexceptional-aborted-CALL-will-revert---final-context-row    (:guard    (*    PEEK_AT_SCENARIO    scenario/CALL_ABORT_WILL_REVERT))
                  (nonexecution-provides-empty-return-data    CALL_ABORT_WILL_REVERT---current-context-update---row-offset))


(defconstraint    call-instruction---unexceptional-aborted-CALL-wont-revert---final-context-row    (:guard    (*    PEEK_AT_SCENARIO    scenario/CALL_ABORT_WONT_REVERT))
