...
(defconstraint    create-instruction---undoing-creator-account-operations-for-deployment-failures    (:guard    (create-instruction---deployment-failure-precondition))
                  (begin
                    ...
                    (vanishes!    (shift    account/ROM_LEX_FLAG     CREATE_second_creator_account_row___row_offset))
                    ...
                    (revert-wit-child-failure-dom-sub-stamps         CREATE_second_creator_account_row___row_offset    0    (create-instruction---createe-revert-stamp))
                    ))
...
(defconstraint    create-instruction---undoing-createe-account-operations-for-deployment-failures    (:guard    (create-instruction---deployment-failure-precondition))
                  (begin
                    ...
                    (vanishes!    (shift    account/ROM_LEX_FLAG     CREATE_second_createe_account_row___row_offset))
