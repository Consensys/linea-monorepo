...
(defun    (create-instruction---init-code-hash-hi)            (shift   stack/HASH_INFO_KECCAK_HI         CREATE_first_stack_row___row_offset))
(defun    (create-instruction---init-code-hash-lo)            (shift   stack/HASH_INFO_KECCAK_LO         CREATE_first_stack_row___row_offset))
