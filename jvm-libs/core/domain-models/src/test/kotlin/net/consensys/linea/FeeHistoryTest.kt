...
class FeeHistoryTest {
  ...
  fun blocksRange() {
    val feeHistory = FeeHistory(
      ...
      baseFeePerBlobGas = listOf(1.toBigInteger(), 2.toBigInteger(), 3.toBigInteger(), 4.toBigInteger()),
      blobGasUsedRatio = listOf(0.1.toBigDecimal(), 0.2.toBigDecimal(), 0.3.toBigDecimal())
    )
