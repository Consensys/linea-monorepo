...
class FakeEthApiClientTest {
  ...
  fun `should update SAFE and adjust FINALIZED and LATEST automatically`() {
    FakeEthApiClient(
      ...
      assertThat(client.findBlockByNumber(BlockParameter.Tag.LATEST).get()?.number).isEqualTo(500UL)
      assertThat(client.findBlockByNumber(BlockParameter.Tag.SAFE).get()?.number).isEqualTo(500UL)
      assertThat(client.findBlockByNumber(BlockParameter.Tag.FINALIZED).get()?.number).isEqualTo(100UL)

      // set SAFE back, should not affect FINALIZED ONLY
      client.setSafeBlockTag(20UL)
      assertThat(client.findBlockByNumber(BlockParameter.Tag.LATEST).get()?.number).isEqualTo(500UL)
      assertThat(client.findBlockByNumber(BlockParameter.Tag.SAFE).get()?.number).isEqualTo(20UL)
      assertThat(client.findBlockByNumber(BlockParameter.Tag.FINALIZED).get()?.number).isEqualTo(20UL)
    }
  }
  ...
  fun `should update LATEST and adjust SAFE and FINALIZED automatically`() {
    FakeEthApiClient(
      ...
      assertThat(client.findBlockByNumber(BlockParameter.Tag.LATEST).get()?.number).isEqualTo(500UL)
      assertThat(client.findBlockByNumber(BlockParameter.Tag.SAFE).get()?.number).isEqualTo(110UL)
      assertThat(client.findBlockByNumber(BlockParameter.Tag.FINALIZED).get()?.number).isEqualTo(100UL)

      // set Latest back, should not affect SAFE and FINALIZED
      client.setLatestBlockTag(20UL)
      assertThat(client.findBlockByNumber(BlockParameter.Tag.LATEST).get()?.number).isEqualTo(20UL)
      assertThat(client.findBlockByNumber(BlockParameter.Tag.SAFE).get()?.number).isEqualTo(20UL)
      assertThat(client.findBlockByNumber(BlockParameter.Tag.FINALIZED).get()?.number).isEqualTo(20UL)
    }
  }
