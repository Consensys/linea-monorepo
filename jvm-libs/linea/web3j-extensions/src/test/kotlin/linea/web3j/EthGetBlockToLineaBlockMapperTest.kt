...
class EthGetBlockToLineaBlockMapperTest {
  ...
  fun `should map transaction with AccessList`() {
    ...
    val txWeb3J = EthBlock.TransactionObject(
      /*hash*/ txJson.getString("hash"),
      /*nonce*/ txJson.getString("nonce"),
      /*blockHash*/ txJson.getString("blockHash"),
      /*blockNumber*/ txJson.getString("blockNumber"),
      /*chainId*/ txJson.getString("chainId"),
      /*transactionIndex*/ txJson.getString("transactionIndex"),
      /*from*/ txJson.getString("from"),
      /*to*/ txJson.getString("to"),
      /*value*/ txJson.getString("value"),
      /*gasPrice*/ txJson.getString("gasPrice"),
      /*gas*/ txJson.getString("gas"),
      /*input*/ txJson.getString("input"),
      /*creates*/ null,
      /*publicKey*/null,
      /*raw*/null,
      /*r*/ txJson.getString("r"),
      /*s*/ txJson.getString("s"),
      /*v*/ txJson.getString("v").toLongFromHex(),
      /*yParity*/ txJson.getString("yParity"),
      /*type*/ txJson.getString("type"),
      /*maxFeePerGas*/null,
      /*maxPriorityFeePerGas*/ null,
      /* accessList*/txJson.getJsonArray("accessList").map { accessListEntry ->
        val accessList = accessListEntry as JsonObject
        AccessListObject(
          /*address*/ accessList.getString("address"),
          /*storageKeys*/ accessList.getJsonArray("storageKeys").map { it as String }
        )
      }
    )
  ...
  fun `it should map EIP1559 tx`() {
    ...
    val txWeb3J = EthBlock.TransactionObject(
      ...
      /*yParity*/ txJson.getString("yParity"),
      /*type*/ txJson.getString("type"),
      /*maxFeePerGas*/ txJson.getString("maxFeePerGas"),
      /*maxPriorityFeePerGas*/ txJson.getString("maxPriorityFeePerGas"),
      /* accessList*/ emptyList()
    )

    val txDomain = txWeb3J.toDomain()
    assertThat(txWeb3J.toDomain()).isEqualTo(
      Transaction(
        nonce = 0UL,
        gasPrice = 0x1017df87UL,
        gasLimit = 0x5208UL,
