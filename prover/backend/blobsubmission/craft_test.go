...
func TestNewSchnarf(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			desc: "SameLength",
			parts: schnarfParts{
				oldSchnarf:       []byte("9cc2e1b9eb24657287f4218215b0e06f74a101b2b9d5a31843cd4389f372244c"),
				snarkHash:        []byte("9b1d412c846ef9a34f0852a84426232abf2d077fd89a51b975fec6ddc7574338"),
				newStateRootHash: []byte("5fb64ae631f8267af639bd760396f28a35e303af3625f1fc5f160c2f08c8ac9b"),
				x:                []byte("29299c0aa183abcc170250464ce7495d78a0649e9eaa9426aa7fcd9f4dbd000b"),
		...
		},
		{
			...
			parts: schnarfParts{
				oldSchnarf:       []byte("d4d775835bab9bc0b03aa23778624da62169072de2005b34b2988d8a64fc857b"),
				snarkHash:        []byte("e44d5326f398e2efc575739a159807546d7852943d3f63609ad61f56f0edb222"),
				newStateRootHash: []byte("4e05eef8509d096d9d25d2488f729b9bffb6b04b74d2e67542cc81423712d1f6"),
				x:                []byte("20d4ecfd922dd4cd55da1492579bd2aaa77590541d16da418f6b22abd13d23eb"),
...
// wantTestSchnarf is a helper function to compute the expected Schnarf hash for
// a test case.
func wantTestSchnarf(t *testing.T, parts schnarfParts) []byte {
	t.Helper()

	var (
		h      = sha3.NewLegacyKeccak256()
		yBytes = parts.y.Bytes()
	)
	h.Write(parts.oldSchnarf)
