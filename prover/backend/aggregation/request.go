...
import "github.com/consensys/zkevm-monorepo/prover/circuits/aggregation"

// Request collects all the fields used to perfom an aggregation request.
type Request struct {
	...
	// List of the compression proofs prover responsees containing the
