...
func applyAccountSegmentToShomei(shomeiState *statemanager.WorldState, accSegment []StateAccessLog) []statemanager.DecodedTrace {
	...
	asp := identifyccountSegment(initAccountValue, accSegment)
...
// identifyccountSegment parses an account segment and returns the
...
func identifyccountSegment(accInitValue types.Account, accSegment []StateAccessLog) accountSegmentPattern {
