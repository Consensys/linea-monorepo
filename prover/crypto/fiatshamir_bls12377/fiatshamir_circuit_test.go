...
func GetCircuitWitnessFSCircuit() (*FSCircuit, *FSCircuit) {
	...
	witness.C[0] = field.NewFrontendFromKoala(c[0])
	witness.C[1] = field.NewFrontendFromKoala(c[1])
	for i := 0; i < 10; i++ {
		witness.D[i] = field.NewFrontendFromKoala(d[i])
	}
	for i := 0; i < 8; i++ {
		witness.R3[i] = field.NewFrontendFromKoala(r3[i])
		witness.SetState[i] = field.NewFrontendFromKoala(setState[i])
		witness.GetState[i] = field.NewFrontendFromKoala(getState[i])
	}
...
func getKoalaFlushSpecificWitness(isKoala bool) (*KoalaFlushSpecificCircuit, *KoalaFlushSpecificCircuit) {
	...
	for i := 0; i < 8; i++ {
		witness.Input[i] = field.NewFrontendFromKoala(input[i])
	}
	for i := 0; i < 8; i++ {
		witness.Output[i] = field.NewFrontendFromKoala(output[i])
	}
...
func TestRandomFieldExt(t *testing.T) {
	...
	witness.Input[0] = field.NewFrontendFromKoala(input[0])
	witness.Input[1] = field.NewFrontendFromKoala(input[1])
...
func TestStateRoundTrip(t *testing.T) {
	...
	for i := 0; i < 8; i++ {
		witness.InitialState[i] = field.NewFrontendFromKoala(initialState[i])
		witness.FinalState[i] = field.NewFrontendFromKoala(finalState[i])
	}
...
func TestMultipleRandomFieldCalls(t *testing.T) {
	...
	for i := 0; i < 8; i++ {
		witness.Output1[i] = field.NewFrontendFromKoala(output1[i])
		witness.Output2[i] = field.NewFrontendFromKoala(output2[i])
	}
...
func TestMixedUpdate(t *testing.T) {
	...
	witness.KoalaInput[0] = field.NewFrontendFromKoala(koalaInput[0])
	witness.KoalaInput[1] = field.NewFrontendFromKoala(koalaInput[1])
