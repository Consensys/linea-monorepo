...
func TestRandomFieldExt(t *testing.T) {
	...
	witness.OutputExt.B0.A0 = field.NewFrontendFromKoala(output.B0.A0)
	witness.OutputExt.B0.A1 = field.NewFrontendFromKoala(output.B0.A1)
	witness.OutputExt.B1.A0 = field.NewFrontendFromKoala(output.B1.A0)
	witness.OutputExt.B1.A1 = field.NewFrontendFromKoala(output.B1.A1)
