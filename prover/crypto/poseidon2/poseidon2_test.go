...
func TestPoseidon2BlockCompression(t *testing.T) {
	...
	for i := 0; i < 100; i++ {
		var zero [8]field.Element
		var blockOne [8]field.Element
		var blocktwo [8]field.Element
		...
		var result [8]field.Element // Array to store the 8 reconstructed Elements
