...
// AlgebraicChecks performs the following checks:
// 1- ∑ₖαᵏys[k] = linComb(x)
// 2- ∑ₖαᵏcolumns[j][k] = linComb[j] for j in entryList
// 3- check that linComb is a RS code
// func AlgebraicChecks(vinput VerifierInput, proof OpeningProof) error {

// 	err := CheckLinComb(proof.LinearCombination, vinput.EntryList, vinput.Alpha, proof.Columns)
// 	if err != nil {
// 		return err
// 	}

// 	err = CheckIsCodeWord(vinput.RsParams, proof.LinearCombination)
// 	if err != nil {
// 		return err
// 	}

// 	err = CheckStatement(proof.LinearCombination, vinput.Ys, vinput.X, vinput.Alpha)
// 	return err
...
// 		// Check the linear combination is consistent with the opened column
// 		y := vortex.EvalBasePolyCanonical(fullCol, v.RandomCoin)
...
// 	alphaYPrime := vortex.EvalFextPolyCanonical(Yjoined, v.RandomCoin)
