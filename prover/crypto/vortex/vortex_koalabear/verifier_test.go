...
func getProofVortexNCommitmentsWithMerkle(t *testing.T, nCommitments, nbPolys, polySize, rate int, withSis bool) (
	...
	*vortex.OpeningProof,
	...
	proof.LinearCombination = vortex.LinearCombination(encodedMatrices, vi.Alpha)

	var merkleProofs [][]smt_koalabear.Proof
	merkleProofs = SelectColumnsAndMerkleProofs(proof, vi.EntryList, encodedMatrices, trees)
