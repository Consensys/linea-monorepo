...
// circuit.
func gkrMiMC(gkr *gkrapi.API, initStates, blocks []T) (apiGkr.Variable, error) {
...
func checkWithGkr(api frontend.API, initStates, blocks, allegedNewState []T) {
	...
	multicommit.WithCommitment(
		api,
		func(api frontend.API, initialChallenge T) error {
