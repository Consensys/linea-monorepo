...
func setDefaultTracesLimit() {
	...
	viper.SetDefault("traces_limits.BYTE_SHR256", 131072)
	viper.SetDefault("traces_limits.BYTE_SAR256", 131072)
	...
	viper.SetDefault("traces_limits.FILL_BYTES_FROM", 131072)
	...
	// Beta v4.0
	viper.SetDefault("traces_limits_large.BYTE_SHL256", 262144)
	viper.SetDefault("traces_limits_large.BYTE_SHR256", 262144)
	viper.SetDefault("traces_limits_large.BYTE_SAR256", 262144)
	...
	viper.SetDefault("traces_limits_large.FILL_BYTES_FROM", 262144)
