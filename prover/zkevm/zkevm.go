...
import (
	...
	"github.com/consensys/zkevm-monorepo/prover/zkevm/prover/keccak"
...
func (z *ZkEvm) Compile(suite compilationSuite) *ZkEvm {
...
func (z *ZkEvm) prove(input *Witness) (prover wizard.ProverStep) {
	return func(run *wizard.ProverRuntime) {
		...
		// assign themselves.
		arithmetization.Assign(run, input.ExecTraces)
