...
// Sha2Blocks consists in the input columns to use to construct the SHA2
// verification circuit.
type Sha2Blocks struct {
...
// sha2BlockHashing stores the compilation context of checking the correctness
// of the sha2 compression function.
type sha2BlockHashing struct {
...
// CheckSha2BlockHash
func CheckSha2BlockHash(comp *wizard.CompiledIOP, inp *Sha2Blocks) *sha2BlockHashing {
...
func (sbh *sha2BlockHashing) WithCircuit(comp *wizard.CompiledIOP, options ...plonk.Option) *sha2BlockHashing {
