...
func (c *G1ElementWizard) ToG1Element(api frontend.API, fp *emulated.Field[sw_bn254.BaseField]) sw_bn254.G1Affine {
	PXlimbs := make([]T, fpParams.NbLimbs())
	PYlimbs := make([]T, fpParams.NbLimbs())
...
func (c *G2ElementWizard) ToG2Element(api frontend.API, fp *emulated.Field[sw_bn254.BaseField]) sw_bn254.G2Affine {
	QXAlimbs := make([]T, fpParams.NbLimbs())
	QXBlimbs := make([]T, fpParams.NbLimbs())
	QYAlimbs := make([]T, fpParams.NbLimbs())
	QYBlimbs := make([]T, fpParams.NbLimbs())
...
func (c *GtElementWizard) ToGtElement(api frontend.API, fp *emulated.Field[sw_bn254.BaseField]) sw_bn254.GTEl {
	C0B0XLimbs := make([]T, fpParams.NbLimbs())
	C0B0YLimbs := make([]T, fpParams.NbLimbs())
	C0B1XLimbs := make([]T, fpParams.NbLimbs())
	C0B1YLimbs := make([]T, fpParams.NbLimbs())
	C0B2XLimbs := make([]T, fpParams.NbLimbs())
	C0B2YLimbs := make([]T, fpParams.NbLimbs())
	C1B0XLimbs := make([]T, fpParams.NbLimbs())
	C1B0YLimbs := make([]T, fpParams.NbLimbs())
	C1B1XLimbs := make([]T, fpParams.NbLimbs())
	C1B1YLimbs := make([]T, fpParams.NbLimbs())
	C1B2XLimbs := make([]T, fpParams.NbLimbs())
	C1B2YLimbs := make([]T, fpParams.NbLimbs())
