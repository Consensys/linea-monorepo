...
func numToPower2(n int) (colNum, colPower2 smartvectors.SmartVector) {
	...
	return smartvectors.RightZeroPadded(num, size), smartvectors.RightPadded(power2, field.One(), size)
}
...
func baseConversionKeccakBaseBDirtyToUint4() (uint4Col, baseBDirtyCol smartvectors.SmartVector) {
