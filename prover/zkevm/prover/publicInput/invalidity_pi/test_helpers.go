...
type FixedInputs struct {
	TxHashLimbs    [zkevmcommon.NbLimbU256]field.Element       // 16 limbs for 256-bit tx hash
	FromLimbs      [zkevmcommon.NbLimbEthAddress]field.Element // 10 limbs for 160-bit address
