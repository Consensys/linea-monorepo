...
func TestAssignInsert(t *testing.T) {
	...
	builder := newAssignmentBuilder(16)
...
func assertCorrectMerkleProofsUsingWizard(t *testing.T, builder *assignmentBuilder) {
	...
	largeSize := utils.NextPowerOfTwo(builder.maxNumProofs * merkleTreeDepth)
	define := func(b *wizard.Builder) {
		...
		merkle.MerkleProofCheckWithReuse(b.CompiledIOP, "TEST", merkleTreeDepth, builder.maxNumProofs, proofcol, rootscol, leavescol, poscol, useNextMerkleProofCol, isActiveCol, counterCol)
	}
