			...
			if cmp == nil || lastMaxLen < maxLen {
				...
				cmp = wizard.Compile(
					func(b *wizard.Builder) {
						...
						p256Verify = newP256Verify(b.CompiledIOP, limits, newP256VerifyDataSource(b.CompiledIOP)) // ref zkevm_modules.go
...
func TestP256VerifyOnTrace(t *testing.T) {
	...
	testP256VerifyOnTrace(t, "../testdata_devnet/*/*.lt", limits)
}
