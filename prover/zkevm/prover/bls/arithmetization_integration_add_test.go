			...
			if cmp == nil || lastMaxLen < maxLen {
				...
				cmp = wizard.Compile(
					func(b *wizard.Builder) {
						...
						blsAdd = newAdd(b.CompiledIOP, g, limits, newAddDataSource(b.CompiledIOP, g)) // ref zkevm_modules.go
						blsAdd = blsAdd.
...
func TestBlsG1AddOnTrace(t *testing.T) {
	...
	// testBlsAddOnTrace(t, G1, "testdata/BlsG1AddTest_*.lt", limits)
	testBlsAddOnTrace(t, G1, "../testdata_devnet/*/*.lt", limits)
}
...
func TestBlsG2AddOnTrace(t *testing.T) {
	...
	// testBlsAddOnTrace(t, G2, "testdata/BlsG2AddTest_*.lt", limits)
	testBlsAddOnTrace(t, G2, "../testdata_devnet/*/*.lt", limits)
