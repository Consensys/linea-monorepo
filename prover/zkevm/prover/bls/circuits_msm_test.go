...
func TestBlsG2Msm(t *testing.T) {
	limits := &Limits{
		NbG2MulInputInstances:          6,
		NbG2MulCircuitInstances:        13,
		NbG2MembershipInputInstances:   2,
		NbG2MembershipCircuitInstances: 1,
	}
	...
	cmp := wizard.Compile(
		func(b *wizard.Builder) {
			...
			blsMsm = newMsm(b.CompiledIOP, G2, limits, blsMsmSource, []query.PlonkOption{query.PlonkRangeCheckOption(16, 6, true)})
		},
		dummy.Compile,
	)
