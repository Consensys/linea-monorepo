...
func testBlsPair(t *testing.T, withCircuit bool) {
	limits := &Limits{
		...
		NbMillerLoopCircuitInstances:   100,
		NbFinalExpInputInstances:       4,
		NbFinalExpCircuitInstances:     100,
		NbG1MembershipInputInstances:   4,
		NbG1MembershipCircuitInstances: 100,
		NbG2MembershipInputInstances:   4,
		NbG2MembershipCircuitInstances: 100,
	}
	f, err := os.Open("testdata/bls_pairing_inputs.csv")
