			...
			if cmp == nil || lastMaxLen < maxLen {
				...
				cmp = wizard.Compile(
					func(b *wizard.Builder) {
						...
						blsMsm = newMsm(b.CompiledIOP, g, limits, newMsmDataSource(b.CompiledIOP, g)) // ref zkevm_modules.go
						blsMsm = blsMsm.
...
func TestBlsG1MsmOnTrace(t *testing.T) {
	...
	// testBlsMsmOnTrace(t, G1, "testdata/BlsG1MsmTest_*.lt", limits)
	testBlsMsmOnTrace(t, G1, "../testdata_devnet/*/*.lt", limits)
}
...
func TestBlsG2MsmOnTrace(t *testing.T) {
	...
	// testBlsMsmOnTrace(t, G2, "testdata/BlsG2MsmTest_*.lt", limits)
	testBlsMsmOnTrace(t, G2, "../testdata_devnet/*/*.lt", limits)
}
