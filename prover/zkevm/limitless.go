...
var DiscoveryAdvices = []distributed.ModuleDiscoveryAdvice{
	...
	{BaseSize: 32, Cluster: "STATIC", Column: "REPEATED_PA[T]ERN_4741_24_PA[T]ERN"},
	{BaseSize: 32, Cluster: "STATIC", Column: "REPEATED_PA[T]ERN_6890_20_PA[T]ERN"},
	...
	{BaseSize: 16, Cluster: "STATIC", Column: "REPEATED_PA[T]ERN_6306_16_PA[T]ERN"},
	{BaseSize: 32, Cluster: "STATIC", Column: "REPEATED_PA[T]ERN_6453_20_PA[T]ERN"},
	{BaseSize: 32, Cluster: "STATIC", Column: "REPEATED_PA[T]ERN_4304_24_PA[T]ERN"},
	{BaseSize: 64, Cluster: "STATIC", Column: "REPEATED_PA[T]ERN_1978_64_PA[T]ERN"},
	{BaseSize: 64, Cluster: "STATIC", Column: "REPEATED_PA[T]ERN_6273_64_PA[T]ERN"},
	{BaseSize: 64, Cluster: "STATIC", Column: "REPEATED_PA[T]ERN_6314_64_PA[T]ERN"},
	{BaseSize: 64, Cluster: "STATIC", Column: "REPEATED_PA[T]ERN_6322_64_PA[T]ERN"},
	{BaseSize: 64, Cluster: "STATIC", Column: "REPEATED_PA[T]ERN_6465_64_PA[T]ERN"},
	{BaseSize: 128, Cluster: "STATIC", Column: "REPEATED_PA[T]ERN_6249_128_PA[T]ERN"},
	{BaseSize: 128, Cluster: "STATIC", Column: "REPEATED_PA[T]ERN_6257_128_PA[T]ERN"},
	{BaseSize: 512, Cluster: "STATIC", Column: "REPEATED_PA[T]ERN_6265_512_PA[T]ERN"},
	...
	{BaseSize: 256, Cluster: "SHA2", Column: "SHA2_TAGS_SPAGHE[T]I"},
	...
	{BaseSize: 8192, Cluster: "TINY-STUFFS", Column: "EXECUTION_DATA_MIMC_TAGS_SPAGHE[T]I"},
	...
	{BaseSize: 524288, Cluster: "HUB-KECCAK", Column: "KECCAK_TAGS_SPAGHE[T]I"},
...
func GetAffinities(z *ZkEvm) [][]column.Natural {
	...
	return [][]column.Natural{
		...
		},
		{
			...
			z.WizardIOP.Columns.GetHandle("KECCAK_FILTERS_SPAGHE[T]I").(column.Natural),
		...
		},
		{
			...
			z.WizardIOP.Columns.GetHandle("SHA2_FILTERS_SPAGHE[T]I").(column.Natural),
