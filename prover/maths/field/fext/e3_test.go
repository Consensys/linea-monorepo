...
func TestE3Ops(t *testing.T) {
	...
	properties.Property("[BLS12-377] BatchInvertE3 should output the same result as Inverse", prop.ForAll(
		func(a, b, c *E3) bool {
	...
	properties.Property("[BLS12-377] Mulbynonres should be the same as multiplying by (0,1)", prop.ForAll(
		func(a *E3) bool {
			var b, c, d E3
			b.A1.SetOne()
			c.MulByNonResidue(a)
