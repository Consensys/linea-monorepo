...
// VectorFr is a copy type of [koalabear.Vector]
type VectorFr koalabear.Vector
...
// MarshalBinary is an automatically generated wrapper arround [*koalabear.Vector.MarshalBinary]
func (vector *VectorFr) MarshalBinary() ([]byte, error) {
	// Casting the parameters using unsafe
	_vector := (*koalabear.Vector)(unsafe.Pointer(vector))

	r0, r1 := _vector.MarshalBinary()

	return r0, r1
}


// UnmarshalBinary is an automatically generated wrapper arround [*koalabear.Vector.UnmarshalBinary]
func (vector *VectorFr) UnmarshalBinary(data []byte) error {
	// Casting the parameters using unsafe
	_vector := (*koalabear.Vector)(unsafe.Pointer(vector))

	r0 := _vector.UnmarshalBinary(data)

	return r0
}


// WriteTo is an automatically generated wrapper arround [*koalabear.Vector.WriteTo]
func (vector *VectorFr) WriteTo(w io.Writer) (int64, error) {
	// Casting the parameters using unsafe
	_vector := (*koalabear.Vector)(unsafe.Pointer(vector))

	r0, r1 := _vector.WriteTo(w)

	return r0, r1
}


// AsyncReadFrom is an automatically generated wrapper arround [*koalabear.Vector.AsyncReadFrom]
func (vector *VectorFr) AsyncReadFrom(r io.Reader) (int64, error, chan error) {
	// Casting the parameters using unsafe
	_vector := (*koalabear.Vector)(unsafe.Pointer(vector))

	r0, r1, r2 := _vector.AsyncReadFrom(r)

	return r0, r1, r2
}


// ReadFrom is an automatically generated wrapper arround [*koalabear.Vector.ReadFrom]
func (vector *VectorFr) ReadFrom(r io.Reader) (int64, error) {
	// Casting the parameters using unsafe
	_vector := (*koalabear.Vector)(unsafe.Pointer(vector))

	r0, r1 := _vector.ReadFrom(r)

	return r0, r1
}


// String is an automatically generated wrapper arround [koalabear.Vector.String]
func (vector VectorFr) String() string {
	// Casting the parameters using unsafe
	_vector := *(*koalabear.Vector)(unsafe.Pointer(&vector))
...
// Len is an automatically generated wrapper arround [koalabear.Vector.Len]
func (vector VectorFr) Len() int {
	// Casting the parameters using unsafe
	_vector := *(*koalabear.Vector)(unsafe.Pointer(&vector))
...
// Less is an automatically generated wrapper arround [koalabear.Vector.Less]
func (vector VectorFr) Less(i int, j int) bool {
	// Casting the parameters using unsafe
	_vector := *(*koalabear.Vector)(unsafe.Pointer(&vector))
...
// Swap is an automatically generated wrapper arround [koalabear.Vector.Swap]
func (vector VectorFr) Swap(i int, j int) {
	// Casting the parameters using unsafe
	_vector := *(*koalabear.Vector)(unsafe.Pointer(&vector))
...
// SetRandom is an automatically generated wrapper arround [koalabear.Vector.SetRandom]
func (vector VectorFr) SetRandom() error {
	// Casting the parameters using unsafe
	_vector := *(*koalabear.Vector)(unsafe.Pointer(&vector))

	r0 := _vector.SetRandom()

	return r0
}


// MustSetRandom is an automatically generated wrapper arround [koalabear.Vector.MustSetRandom]
func (vector VectorFr) MustSetRandom() {
	// Casting the parameters using unsafe
	_vector := *(*koalabear.Vector)(unsafe.Pointer(&vector))

	_vector.MustSetRandom()

	return 
}


// Add is an automatically generated wrapper arround [*koalabear.Vector.Add]
func (vector *VectorFr) Add(a VectorFr, b VectorFr) {
	// Casting the parameters using unsafe
	_vector := (*koalabear.Vector)(unsafe.Pointer(vector))
	_a := *(*koalabear.Vector)(unsafe.Pointer(&a))
	_b := *(*koalabear.Vector)(unsafe.Pointer(&b))
...
// Sub is an automatically generated wrapper arround [*koalabear.Vector.Sub]
func (vector *VectorFr) Sub(a VectorFr, b VectorFr) {
	// Casting the parameters using unsafe
	_vector := (*koalabear.Vector)(unsafe.Pointer(vector))
	_a := *(*koalabear.Vector)(unsafe.Pointer(&a))
	_b := *(*koalabear.Vector)(unsafe.Pointer(&b))
...
// Sum is an automatically generated wrapper arround [*koalabear.Vector.Sum]
func (vector *VectorFr) Sum() Fr {
	// Casting the parameters using unsafe
	_vector := (*koalabear.Vector)(unsafe.Pointer(vector))
...
// ScalarMul is an automatically generated wrapper arround [*koalabear.Vector.ScalarMul]
func (vector *VectorFr) ScalarMul(a VectorFr, b *Fr) {
	// Casting the parameters using unsafe
	_vector := (*koalabear.Vector)(unsafe.Pointer(vector))
	_a := *(*koalabear.Vector)(unsafe.Pointer(&a))
	_b := (*koalabear.Element)(unsafe.Pointer(b))

	_vector.ScalarMul(_a, _b)

	return 
}


// InnerProduct is an automatically generated wrapper arround [*koalabear.Vector.InnerProduct]
func (vector *VectorFr) InnerProduct(other VectorFr) Fr {
	// Casting the parameters using unsafe
	_vector := (*koalabear.Vector)(unsafe.Pointer(vector))
	_other := *(*koalabear.Vector)(unsafe.Pointer(&other))

	_r0 := _vector.InnerProduct(_other)
...
// Mul is an automatically generated wrapper arround [*koalabear.Vector.Mul]
func (vector *VectorFr) Mul(a VectorFr, b VectorFr) {
	// Casting the parameters using unsafe
	_vector := (*koalabear.Vector)(unsafe.Pointer(vector))
	_a := *(*koalabear.Vector)(unsafe.Pointer(&a))
	_b := *(*koalabear.Vector)(unsafe.Pointer(&b))
