	...
	testCases := []struct {
	...
	}{
		{
			...
			inputs: []smartvectors.SmartVector{
				...
				LeftPadded(vectorext.Constant(two, 12), two, 16),
				RightPadded(vectorext.Constant(two, 12), two, 16),
			},
			expectedRes: NewRegularExt(vectorext.Constant(fext.NewElement(6, 3*fieldPaddingInt()), 16)),
			fn:          Add,
		},
		{
			...
			expectedRes: NewRegularExt(vectorext.Constant(*eight, 16)),
			fn:          Mul,
		},
		{
			...
			inputs: []smartvectors.SmartVector{
				...
				LeftPadded(vectorext.Constant(two, 12), two, 16),
				RightPadded(vectorext.Constant(two, 12), two, 16),
				NewRegularExt(vectorext.Constant(two, 16)),
			},
			expectedRes: NewRegularExt(vectorext.Constant(fext.NewElement(8, 4*fieldPaddingInt()), 16)),
			fn:          Add,
		},
	}
