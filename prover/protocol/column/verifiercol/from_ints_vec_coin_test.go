...
// 				defineInclu := func(build *wizard.Builder[zk.NativeElement]) {
...
// 				proveInclu := func(run *wizard.ProverRuntime[zk.NativeElement]) {
// 					// I should not need to do anything for the FromIntVec coin
// 					run.AssignColumn(P1, testP1)
// 				}

// 				// Compile with the full suite
// 				compiled := wizard.Compile[zk.NativeElement](defineInclu,
// 					compiler.Arcane(
