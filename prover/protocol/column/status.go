...
// Status is a tag that we associate to a [github.com/consensys/linea-monorepo/prover/protocol/ifaces.Column[T]]. The status carries
...
const (
	...
	// Committed marks that a [github.com/consensys/linea-monorepo/prover/protocol/ifaces.Column[T]] is to be sent to the oracle,
	...
	Committed
	// Proof indicates that the [github.com/consensys/linea-monorepo/prover/protocol/ifaces.Column[T]] should be sent to the verifier.
	...
	// compilation process.
	Proof
	// Precomputed indicates that the [github.com/consensys/linea-monorepo/prover/protocol/ifaces.Column[T]] is defined offline during
