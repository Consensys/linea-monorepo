...
func TestDistributedProjectionBothAAndB(t *testing.T) {
	var (
	...
	testcases := []struct {
	...
	}{
		{
			...
			HornerParam: field.One(),
			QueryName:   "DistributedProjectionTestBothAAndB",
			DefineFunc: func(builder *wizard.Builder) {
				...
				DP = builder.CompiledIOP.InsertDistributedProjection(round, "DistributedProjectionTestBothAAndB",
