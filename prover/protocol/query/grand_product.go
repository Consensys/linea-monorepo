...
func (gp GrandProductParams) UpdateFS(fs *hashtypes.Poseidon2FieldHasherDigest) {
	fiatshamir.Update(fs, gp.BaseY)
}

func (gp GrandProductParams) UpdateFSExt(fs *hashtypes.Poseidon2FieldHasherDigest) {
