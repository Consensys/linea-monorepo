...
func (p UnivariateEvalParams) UpdateFS(state *hashtypes.Poseidon2FieldHasherDigest) {
	fiatshamir.Update(state, p.Ys...)
}

func (p UnivariateEvalParams) UpdateFSExt(state *hashtypes.Poseidon2FieldHasherDigest) {
