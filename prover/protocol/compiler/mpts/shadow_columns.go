...
func autoAssignedShadowRow[T zk.Element](comp *wizard.CompiledIOP[T], size, round, id int) ifaces.Column[T] {
...
func precomputedShadowRow[T zk.Element](comp *wizard.CompiledIOP[T], size, i int) ifaces.Column[T] {
