...
func autoAssignedShadowRow[T zk.Element](comp *wizard.CompiledIOP, size, round, id int) ifaces.Column[T] {
...
func precomputedShadowRow[T zk.Element](comp *wizard.CompiledIOP, size, i int) ifaces.Column[T] {
