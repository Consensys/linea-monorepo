...
// Name for the accessor returning collapse^{t=numColToOpenn}
func (ctx *SelfRecursionCtx) collapsePowTName() string {
	return fmt.Sprintf("%v_POW_T", ctx.Coins.Collapse.Name)
}
