...
type Columns struct {
	...
	Rooth []ifaces.Column[T]

	// Precomputed roots
	PrecompRoot ifaces.Column[T]
	...
	// limb expanded form.
	WholePreimagesSis []ifaces.Column[T]

	// (Proof, already computed)
	WholePreimagesNonSis []ifaces.Column[T]
