...
type Columns struct {
	...
	ConcatenatedDhQ ifaces.Column // no need to extend to blockSize here
...
type Poseidon2MetaData struct {
	...
	ConcatenatedHashPreimages []ifaces.Column // no need to extend to blockSize here
}
...
type SelfRecursionCtx struct {
	...
	Columns Columns
	// Poseidon2MetaData contains the metadata for the MiMC hash check
