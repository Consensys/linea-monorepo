...
type NonSisMetaData struct {
	...
	NonSisLeaves [blockSize][]ifaces.Column // extend to blockSize here
	// NonHashPreimages[i] stores the concatenated preimages of all Poseidon2 hash chunks
	// of the selected columns for the ith non SIS round
	NonHashPreimages [][blockSize]ifaces.Column // extend to blockSize here
}
