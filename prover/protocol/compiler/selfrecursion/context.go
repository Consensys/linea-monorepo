...
type Columns struct {
	...
	SisHash [blockSize]ifaces.Column
	...
	SisRoundLeaves [blockSize][]ifaces.Column // extend to blockSize here
...
type NonSisMetaData struct {
	...
	// ConcatenatedHashPreimages[i] stores the concatenated preimages of all Poseidon2 hash chunks
	// of the selected columns for the ith non SIS round
	ConcatenatedHashPreimages [][blockSize]ifaces.Column // extend to blockSize here
}
