...
// steps.
type GnarkVerifierStepGen func(frontend.API, GnarkRuntime)

// VerifierCircuitAnalytic collects analytic datas on a verifier circuit
type VerifierCircuitAnalyticGen struct {
	NumCols            int
	NumUnivariate      int
	NumInnerProduct    int
...
func AssignVerifierCircuitGen(comp *CompiledIOP, proof Proof, numRound int) *VerifierCircuit {
...
func (c *VerifierCircuit) VerifyGen(api frontend.API) {
...
func (c *VerifierCircuit) GenerateCoinsForRoundGen(api frontend.API, currRound int) {
...
func (c *VerifierCircuit) GetRandomCoinFieldGen(name coin.Name) frontend.Variable {
	/*
...
func (c *VerifierCircuit) GetRandomCoinIntegerVecGen(name coin.Name) []frontend.Variable {
	/*
		Early check, ensures the coin has been registered at all
		and that it has the correct type
	*/
...
func (c *VerifierCircuit) GetRandomCoinFieldExtGen(name coin.Name) gnarkfext.Element {
	/*
		Early check, ensures the coin has been registered at all
		and that it has the correct type
	*/
...
func (c *VerifierCircuit) GetUnivariateParamsGen(name ifaces.QueryID) query.GnarkUnivariateEvalParams {
...
// not found.
func (c *VerifierCircuit) GetUnivariateEvalGen(name ifaces.QueryID) query.UnivariateEval {
...
func (c *VerifierCircuit) GetInnerProductParamsGen(name ifaces.QueryID) query.GnarkInnerProductParams {
...
func (c *VerifierCircuit) GetLocalPointEvalParamsGen(name ifaces.QueryID) query.GnarkLocalOpeningParams {
...
func (c *VerifierCircuit) GetLogDerivSumParamsGen(name ifaces.QueryID) query.GnarkLogDerivSumParams {
...
func (c *VerifierCircuit) GetGrandProductParamsGen(name ifaces.QueryID) query.GnarkGrandProductParams {
...
func (c *VerifierCircuit) GetHornerParamsGen(name ifaces.QueryID) query.GnarkHornerParams {
...
func (c *VerifierCircuit) GetColumnGen(name ifaces.ColID) []frontend.Variable {
...
func (c *VerifierCircuit) GetColumnBaseGen(name ifaces.ColID) ([]frontend.Variable, error) {
...
func (c *VerifierCircuit) GetColumnExtGen(name ifaces.ColID) []gnarkfext.Element {
...
func (c *VerifierCircuit) GetColumnAtGen(name ifaces.ColID, pos int) frontend.Variable {
	return c.GetColumn(name)[pos]
}

func (c *VerifierCircuit) GetColumnAtBaseGen(name ifaces.ColID, pos int) (frontend.Variable, error) {
	if !c.Spec.Columns.GetHandle(name).IsBase() {
...
func (c *VerifierCircuit) GetColumnAtExGen(name ifaces.ColID, pos int) gnarkfext.Element {
	if !c.Spec.Columns.GetHandle(name).IsBase() {
...
func (c *VerifierCircuit) GetParamsGen(id ifaces.QueryID) ifaces.GnarkQueryParams {
...
func (c *VerifierCircuit) AssignColumnGen(id ifaces.ColID, sv smartvectors.SmartVector) {
	column := smartvectors.IntoGnarkAssignment(sv)
	c.ColumnsIDs.InsertNew(id, len(c.Columns))
	c.Columns = append(c.Columns, column)
}

func (c *VerifierCircuit) AssignColumnExtGen(id ifaces.ColID, sv smartvectors.SmartVector) {
...
// witness of the verifier circuit.
func (c *VerifierCircuit) AllocInnerProductGen(qName ifaces.QueryID, qInfo query.InnerProduct) {
	// Note that nil is the default value for frontend.Variable
...
func (c *VerifierCircuit) AllocLocalOpeningGen(qName ifaces.QueryID, qInfo query.LocalOpening) {
	// Note that nil is the default value for frontend.Variable
...
// of the verifier circuit.
func (c *VerifierCircuit) AllocLogDerivativeSumGen(qName ifaces.QueryID, qInfo query.LogDerivativeSum) {
...
// of the verifier circuit.
func (c *VerifierCircuit) AllocGrandProductGen(qName ifaces.QueryID, qInfo query.GrandProduct) {
...
// of the verifier circuit.
func (c *VerifierCircuit) AllocHornerGen(qName ifaces.QueryID, qInfo *query.Horner) {
...
func (c *VerifierCircuit) AssignUnivariateEvalGen(qName ifaces.QueryID, params query.UnivariateEvalParams) {
	// Note that nil is the default value for frontend.Variable
	c.UnivariateParamsIDs.InsertNew(qName, len(c.UnivariateParams))
...
func (c *VerifierCircuit) AssignInnerProductGen(qName ifaces.QueryID, params query.InnerProductParams) {
	// Note that nil is the default value for frontend.Variable
	c.InnerProductIDs.InsertNew(qName, len(c.InnerProductParams))
...
func (c *VerifierCircuit) AssignLocalOpeningGen(qName ifaces.QueryID, params query.LocalOpeningParams) {
	// Note that nil is the default value for frontend.Variable
	c.LocalOpeningIDs.InsertNew(qName, len(c.LocalOpeningParams))
...
func (c *VerifierCircuit) AssignLogDerivativeSumGen(qName ifaces.QueryID, params query.LogDerivSumParams) {
	// Note that nil is the default value for frontend.Variable
	c.LogDerivSumIDs.InsertNew(qName, len(c.LogDerivSumParams))
...
// into the witness of the verifier circuit.
func (c *VerifierCircuit) AssignGrandProductGen(qName ifaces.QueryID, params query.GrandProductParams) {
	// Note that nil is the default value for frontend.Variable
	c.GrandProductIDs.InsertNew(qName, len(c.GrandProductParams))
...
// of the verifier circuit.
func (c *VerifierCircuit) AssignHornerGen(qName ifaces.QueryID, params query.HornerParams) {
	// Note that nil is the default value for frontend.Variable
	c.HornerIDs.InsertNew(qName, len(c.HornerParams))
...
func (c *VerifierCircuit) GetPublicInputGen(api frontend.API, name string) frontend.Variable {
...
func (c *VerifierCircuit) AnalyzeGen() *VerifierCircuitAnalytic {
...
func (a *VerifierCircuitAnalytic) WithDetailsGen(c *VerifierCircuit) *VerifierCircuitAnalytic {
