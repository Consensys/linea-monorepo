...
type GnarkRuntime interface {
	...
	GetHasherFactory() hash_factory.HasherFactory
...
type VerifierCircuit struct {
	...
	HasherFactory hash_factory.HasherFactory `gnark:"-"`
...
// if none is set.
func (c *VerifierCircuit) GetHasherFactory() hash_factory.HasherFactory {
	return c.HasherFactory
}

// SetHasherFactory sets the hasher factory of the verifier circuit
func (c *VerifierCircuit) SetHasherFactory(hf hash_factory.HasherFactory) {
	c.HasherFactory = hf
}
