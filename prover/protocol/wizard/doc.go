// The package `wizard` provides the main structure articulating the framework.
...
//
//   - [CompiledIOP] stores a represention of the elaborated
...
//     of gnark circuit. It provides a way to do recursive composition of the
//     wizard into a gnark circuit.
//
// Here is a minimal example of the definition of a protocol to prover knowledge
...
//	// in the "define" function require an explict assignment from the user. It
...
//
//		// This instantiate the protocol, converting all the Wizard queries and
...
//		proof := wizard.Prover(compiled, proveFibo)
//
