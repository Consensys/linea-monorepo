...
func DeserializeRecursion(data []byte, recurSegComp *wizard.CompiledIOP) (*recursion.Recursion, error) {
...
func DeSerializePlonkCktInWizard(data []byte, comp *wizard.CompiledIOP) (frontend.Circuit, error) {
