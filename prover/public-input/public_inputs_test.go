...
func TestAggregation(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			Res: "0x004fe85d45f46251ccf80370a39357e22dcf62e57c1fe3680d3d264ecea629e0",
		},
	}
...
// TestIsAllowedCircuitIDBoundToPublicInput verifies that IsAllowedCircuitID is
// cryptographically committed to in the public input. Two aggregations identical
// except for the mask must produce different digests.
func TestIsAllowedCircuitIDBoundToPublicInput(t *testing.T) {
	base := Aggregation{
		FinalShnarf:                             "0x3f01b1a726e6317eb05d8fe8b370b1712dc16a7fde51dd38420d9a474401291c",
		ParentAggregationFinalShnarf:            "0x0f20c85d35a21767e81d5d2396169137a3ef03f58391767a17c7016cc82edf2e",
		ParentAggregationLastBlockTimestamp:     1711742796,
	...
	withMask := base
	withMask.IsAllowedCircuitID = 0xDEADBEEF

	require.NotEqual(t, base.GetPublicInputHex(), withMask.GetPublicInputHex(),
		"changing IsAllowedCircuitID must produce a different public input")
}
