	...
	testCases := []struct {
	...
	}{
		{
			Inputs: Aggregation{
				...
				ParentStateRootHash:                     "0x1111111111111111111111111111111111111111111111111111111111111111",
			...
			Res: "0x278ccd854b13ef95067ddcdd9f12b98d1eea49dee774466f274a0a122899a17b",
		},
	}
...
func TestAggregationPublicInputBindsParentStateRoot(t *testing.T) {
	base := Aggregation{
		FinalShnarf:                             "0x3f01b1a726e6317eb05d8fe8b370b1712dc16a7fde51dd38420d9a474401291c",
		ParentAggregationFinalShnarf:            "0x0f20c85d35a21767e81d5d2396169137a3ef03f58391767a17c7016cc82edf2e",
		ParentStateRootHash:                     "0x1111111111111111111111111111111111111111111111111111111111111111",
	...
	mutated := base
	mutated.ParentStateRootHash = "0x2222222222222222222222222222222222222222222222222222222222222222"
	includedFieldChanged := base
	includedFieldChanged.FinalShnarf = "0x4f01b1a726e6317eb05d8fe8b370b1712dc16a7fde51dd38420d9a474401291c"

	require.NotEqual(t, base.GetPublicInputHex(), mutated.GetPublicInputHex(),
		"ParentStateRootHash must be bound into the aggregation public input")
	require.NotEqual(t, base.GetPublicInputHex(), includedFieldChanged.GetPublicInputHex(),
		"FinalShnarf must continue to be bound into the aggregation public input")
}
