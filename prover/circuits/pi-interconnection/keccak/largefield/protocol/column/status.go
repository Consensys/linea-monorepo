...
// Status is a tag that we associate to a [github.com/consensys/linea-monorepo/prover/circuits/pi-interconnection/keccak/largefield/protocol/ifaces.Column]. The status carries
...
const (
	...
	// Committed marks that a [github.com/consensys/linea-monorepo/prover/circuits/pi-interconnection/keccak/largefield/protocol/ifaces.Column] is to be sent to the oracle,
	...
	Committed
	// Proof indicates that the [github.com/consensys/linea-monorepo/prover/circuits/pi-interconnection/keccak/largefield/protocol/ifaces.Column] should be sent to the verifier.
	...
	// compilation process.
	Proof
	// Precomputed indicates that the [github.com/consensys/linea-monorepo/prover/circuits/pi-interconnection/keccak/largefield/protocol/ifaces.Column] is defined offline during
