...
type MIMCMetaData struct {
	...
	ToHashSizes []int
	// ColChunksPad[i] = nextPow2(ToHashSizes[i]).
	// This is the padded period used for CheckLinearHash and EvalCoeffBivariate,
	// required because PeriodicSample needs a power-of-two period.
	ColChunksPad []int
