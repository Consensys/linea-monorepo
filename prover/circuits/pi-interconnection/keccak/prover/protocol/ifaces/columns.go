...
// they can then be used to specify a [github.com/consensys/linea-monorepo/prover/circuits/pi-interconnection/keccak/prover/protocol/query.GlobalConstraint] for instance.
//
