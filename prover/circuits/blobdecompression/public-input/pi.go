...
func VerifyBlobConsistency(api frontend.API, blobCrumbs []T, evaluationChallenge [32]T, eip4844Enabled T) (evaluation [2]T, err error) {
...
func newElementFromVars(api frontend.API, x [2]T) *emulated.Element[emulated.BLS12381Fr] {
	field, err := emulated.NewField[emulated.BLS12381Fr](api)
	if err != nil {
		panic(err)
	}
...
func packCrumbsEmulated(api frontend.API, words []T) []*emulated.Element[emulated.BLS12381Fr] {
...
func bls12377ScalarToBls12381Scalar(api frontend.API, v T) *emulated.Element[emulated.BLS12381Fr] {
	field, err := emulated.NewField[emulated.BLS12381Fr](api)
	if err != nil {
		panic(err)
	}
...
func bls12381ScalarToBls12377Scalars(api frontend.API, e *emulated.Element[emulated.BLS12381Fr]) (r [2]T) {
	field, err := emulated.NewField[emulated.BLS12381Fr](api)
	if err != nil {
		panic(err)
	}
