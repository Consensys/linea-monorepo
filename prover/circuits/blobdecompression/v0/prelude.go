...
func Assign(blobData []byte, dict []byte, eip4844Enabled bool, x, y fr381.Element) (assignment frontend.Circuit, publicInput fr.Element, snarkHash []byte, err error) {
	...
	if x377, _err := internal.Bls12381ScalarToBls12377Scalars(x); err != nil {
