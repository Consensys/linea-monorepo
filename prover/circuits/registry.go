...
const (
	...
	InvalidityPrecompileLogsLargeCircuitID     CircuitID = "invalidity-precompile-logs-large"
	InvalidityPrecompileLogsLimitlessCircuitID CircuitID = "invalidity-precompile-logs-limitless"
