...
func TestConglomerateGLInFileRegexp(t *testing.T) {

	var (
		correctM           = "102-103-etv0.2.3-stv1.2.3-getZkProof_GL.json"
		correctL           = "102-103-etv0.2.3-stv1.2.3-getZkProof_GL.json.large"
		correctWithFailM   = "102-103-etv0.2.3-stv1.2.3-getZkProof_GL.json.failure.code_77"
		correctWithFailL   = "102-103-etv0.2.3-stv1.2.3-getZkProof_GL.json.large.failure.code_77"
		correctWith2FailsM = "102-103-etv0.2.3-stv1.2.3-getZkProof_GL.json.failure.code_77.failure.code_77"
		correctWith2FailsL = "102-103-etv0.2.3-stv1.2.3-getZkProof_GL.json.large.failure.code_77.failure.code_77"
	...
	// The rename in case it is deferred to the large prover
	var (
		toLargeM           = "requests/102-103-etv0.2.3-stv1.2.3-getZkProof_GL.json.large.failure.code_137"
		toLargeWithFailM   = "requests/102-103-etv0.2.3-stv1.2.3-getZkProof_GL.json.large.failure.code_137"
		toLargeWith2FailsM = "requests/102-103-etv0.2.3-stv1.2.3-getZkProof_GL.json.large.failure.code_137"
		toLargeWoEtv       = "requests/102-103-stv1.2.3-getZkProof_GL.json.large.failure.code_137"
		toLargeWoStv       = "requests/102-103-etv0.2.3-getZkProof_GL.json.large.failure.code_137"
	)

	// The rename in case it is a success
	var (
		successM           = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_GL.json.success"
		successMWoStv      = "requests-done/102-103-etv0.2.3-getZkProof_GL.json.success"
		successtWoEtv      = "requests-done/102-103-stv1.2.3-getZkProof_GL.json.success"
		successL           = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_GL.json.large.success"
		successWithFailM   = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_GL.json.success"
		successWithFailL   = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_GL.json.large.success"
		successWith2FailsM = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_GL.json.success"
		successWith2FailsL = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_GL.json.large.success"
	)

	// The rename in case it is a panic (code = 2)
	var (
		failM           = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_GL.json.failure.code_2"
		failMWoStv      = "requests-done/102-103-etv0.2.3-getZkProof_GL.json.failure.code_2"
		failtWoEtv      = "requests-done/102-103-stv1.2.3-getZkProof_GL.json.failure.code_2"
		failL           = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_GL.json.large.failure.code_2"
		failWithFailM   = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_GL.json.failure.code_2"
		failWithFailL   = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_GL.json.large.failure.code_2"
		failWith2FailsM = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_GL.json.failure.code_2"
		failWith2FailsL = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_GL.json.large.failure.code_2"
	)
	...
	for _, c := range testCases {
		...
		def, err := ConglomerateGLDefinition(&conf)
		assert.NoError(t, err)
...
func TestConglomerateDistMetadataInFileRegexp(t *testing.T) {
	...
	for _, c := range testCases {
		...
		def, err := ConglomerateDistMetadataDefinition(&conf)
		assert.NoError(t, err)
...
func TestConglomerateLPPInFileRegexp(t *testing.T) {

	var (
		correctM           = "102-103-etv0.2.3-stv1.2.3-getZkProof_LPP.json"
		correctL           = "102-103-etv0.2.3-stv1.2.3-getZkProof_LPP.json.large"
		correctWithFailM   = "102-103-etv0.2.3-stv1.2.3-getZkProof_LPP.json.failure.code_77"
		correctWithFailL   = "102-103-etv0.2.3-stv1.2.3-getZkProof_LPP.json.large.failure.code_77"
		correctWith2FailsM = "102-103-etv0.2.3-stv1.2.3-getZkProof_LPP.json.failure.code_77.failure.code_77"
		correctWith2FailsL = "102-103-etv0.2.3-stv1.2.3-getZkProof_LPP.json.large.failure.code_77.failure.code_77"
		missingEtv         = "102-103-stv1.2.3-getZkProof_LPP.json"
		missingStv         = "102-103-etv0.2.3-getZkProof_LPP.json"
		notAPoint          = "102-103-etv0.2.3-getZkProof_LPPAjson"
		badName            = "102-103-etv0.2.3-stv1.2.3-getAggregatedProof.json"
	)
	...
	// The rename in case it is deferred to the large prover
	var (
		toLargeM           = "requests/102-103-etv0.2.3-stv1.2.3-getZkProof_LPP.json.large.failure.code_137"
		toLargeWithFailM   = "requests/102-103-etv0.2.3-stv1.2.3-getZkProof_LPP.json.large.failure.code_137"
		toLargeWith2FailsM = "requests/102-103-etv0.2.3-stv1.2.3-getZkProof_LPP.json.large.failure.code_137"
		toLargeWoEtv       = "requests/102-103-stv1.2.3-getZkProof_LPP.json.large.failure.code_137"
		toLargeWoStv       = "requests/102-103-etv0.2.3-getZkProof_LPP.json.large.failure.code_137"
	)

	// The rename in case it is a success
	var (
		successM           = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_LPP.json.success"
		successMWoStv      = "requests-done/102-103-etv0.2.3-getZkProof_LPP.json.success"
		successtWoEtv      = "requests-done/102-103-stv1.2.3-getZkProof_LPP.json.success"
		successL           = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_LPP.json.large.success"
		successWithFailM   = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_LPP.json.success"
		successWithFailL   = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_LPP.json.large.success"
		successWith2FailsM = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_LPP.json.success"
		successWith2FailsL = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_LPP.json.large.success"
	)

	// The rename in case it is a panic (code = 2)
	var (
		failM           = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_LPP.json.failure.code_2"
		failMWoStv      = "requests-done/102-103-etv0.2.3-getZkProof_LPP.json.failure.code_2"
		failtWoEtv      = "requests-done/102-103-stv1.2.3-getZkProof_LPP.json.failure.code_2"
		failL           = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_LPP.json.large.failure.code_2"
		failWithFailM   = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_LPP.json.failure.code_2"
		failWithFailL   = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_LPP.json.large.failure.code_2"
		failWith2FailsM = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_LPP.json.failure.code_2"
		failWith2FailsL = "requests-done/102-103-etv0.2.3-stv1.2.3-getZkProof_LPP.json.large.failure.code_2"
	)
	...
	for _, c := range testCases {
		...
		def, err := ConglomerateLPPDefinition(&conf)
		assert.NoError(t, err)
