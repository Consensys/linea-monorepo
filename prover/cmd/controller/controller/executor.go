...
const (
	...
	CodeTooManySegments int = 136  // Too many limitless segments for the regular prover; defer to full-large
...
func runCmd(ctx context.Context, cmdStr string, job *Job, retry bool) Status {
	...
	go func() {
		...
		case CodeSuccess:
			status.What = "success"
		case CodeTooManySegments:
			status.What = "too many GL segments for regular prover"
		case CodeOom:
