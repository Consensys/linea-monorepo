...
// curve returns the C curve identifier for bls12377, baked in at generation time.
func curveID() C.gnark_gpu_plonk2_curve_id_t {
	return C.gnark_gpu_plonk2_curve_id_t(2)
}
