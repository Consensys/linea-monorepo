...
function printUsage(): void {
  console.log("Schema Generator CLI (viem)");
  console.log("");
  console.log("Usage:");
  console.log("  generate-schema-viem <input.sol...> -o <output.json> [options]");
  console.log("  generate-schema-viem <input.sol> <output.json> [options]  (legacy)");
  console.log("");
...
function main(): void {
  ...
  console.log("Storage Schema Generator (viem)");
