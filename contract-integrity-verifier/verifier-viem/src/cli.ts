...
Examples:
  npx @consensys/linea-contract-integrity-verifier-viem -c ./config.json -v
  npx @consensys/linea-contract-integrity-verifier-viem -c ./config.md --contract MyProxy
`);
}
...
async function main(): Promise<void> {
  ...
  console.log("Contract Integrity Verifier (Viem)");
  console.log("=".repeat(60));
