...
import { useApprove, useIsConnected, useMessageService, useExecutionFee } from '@/hooks';
...
export default function Fees() {
  ...
  const { tokenBridgeAddress, token, networkLayer, networkType, toChain, fromChain } = context;
  ...
  return (
    <ul className="space-y-5">
      <li className="">
        <div className="grid w-full grid-cols-2 gap-6 form-control">
          <div>
            <input
              {...register('claim')}
              id="claim-auto"
            ...
            >
              <div className="block">
                <div className="w-full text-md ">Automatic claiming</div>
              </div>
            </label>
          </div>
          <div>
            <input {...register('claim')} id="claim-manual" type="radio" value="manual" className="hidden peer" />
            <label
            ...
            >
              <div className="block">
                <div className="w-full text-md">Manual claiming</div>
              </div>
            </label>
          </div>
        </div>
      ...
      <li>
        ...
        >
          <div className="flex items-center">
            ...
            <div
              className="ml-1 tooltip tooltip-bottom tooltip-info "
              data-tip={
                claim === 'auto'
