...
| `make verify-elf TEST=foo.<ext>`                         | Verify ELF offsets, entry point, stack and heap symbols match the ones in the Makefile |
...
_____________________________________ 0x08800000 ≡ _program_end = IN_ORIGIN * = _in_start
 IN:      ↓ 1 GiB: IN_LENGTH
