...
class QbftConsensusConfigSerializerTest {
  ...
  fun `serialization is deterministic regardless of validator set order`() {
    ...
    val bytes1 = ForkIdSerializers.QbftConsensusConfigSerializer.serialize(config1)
    val bytes2 = ForkIdSerializers.QbftConsensusConfigSerializer.serialize(config2)
