 ...
 */
package org.hyperledger.consensus.qbft.controller;
...
import org.hyperledger.besu.controller.BftBesuControllerBuilder;
import org.hyperledger.besu.controller.BftQueryPluginServiceFactory;
...
import org.hyperledger.consensus.qbft.config.QbftFork;
...
public class QbftBesuControllerBuilder extends BftBesuControllerBuilder {
  ...
  protected BftContext createConsensusContext(
    ...
    final BftValidatorOverrides validatorOverrides =
        convertBftForks(
            genesisConfigOptions.getTransitions().getQbftForks().stream()
                // TODO: Clean up. QbftFork from Besu repo
                .map(QbftFork::fromBesuQbftFork)
                .toList());
