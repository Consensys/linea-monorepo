...
if [[ ! -f "initialization/genesis-besu.json" && ! -f "initialization/genesis-geth.json" && ! -f "initialization/genesis-nethermind.json" ]]; then
    echo "Initialization of timestamp in genesis files for Besu, Geth, and Nethermind."
    date
