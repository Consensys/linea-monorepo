...
describe("Submission and finalization test suite", () => {
  ...
  it.concurrent(
    ...
    async () => {
      ...
      logger.info("Waiting for data submission used to finalize with proof...");
      ...
      logger.info("Waiting for the first DataFinalized event with proof...");
  ...
  it.concurrent(
    ...
    async () => {
      ...
      logger.info(`lastFinalizedL2BlockNumberOnL1=${lastFinalizedL2BlockNumberOnL1}`);
      ...
      logger.info(`safeL2BlockNumber=${safeL2BlockNumber} finalizedL2BlockNumber=${finalizedL2BlockNumber}`);
